(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function v(e) {
      return d(e), g(y(Uint8Array.from(e).reverse()));
    }
    function B(e, t) {
    ...
    let I = (e) => "bigint" == typeof e && a <= e;
    function R(e, t, r) {
      return I(e) && I(t) && I(r) && t <= e && e < r;
    }
    function q(e, t, r, n) {
      if (!R(t, r, n))
        throw Error(
    ...
    function Q(e, t, r = !1, n = {}) {
      ...
      let { nBitLength: o, nByteLength: f } = J(e, t);
      if (f > 2048)
      ...
      let l = Object.freeze({
        ...
        toBytes: (e) => (r ? x(e, f) : B(e, f)),
        fromBytes: (e) => {
          if (e.length !== f)
            throw Error(
              "Field.fromBytes: expected " + f + " bytes, got " + e.length
            );
          return r ? v(e) : E(e);
        },
        invertBatch: (e) => G(l, e),
    ...
    function ef(e, t, r) {
      let { windowSize: n, mask: i, maxNumber: o, shiftBy: f } = r,
        l = Number(e & i),
        a = e >> f;
      l > n && ((l -= o), (a += er));
      let u = t * n,
    ...
    function ed(e) {
      void 0 !== e.lowS && c("lowS", e.lowS),
        void 0 !== e.prehash && c("prehash", e.prehash);
    }
    let ec = {
        ...
        _tlv: {
          ...
          decode(e, t) {
            ...
            if (128 & i) {
              ...
              let f = t.subarray(n, n + e);
              if (f.length !== e)
                throw new r("tlv.decode: length bytes not complete");
              if (0 === f[0])
                throw new r("tlv.decode(long): zero leftmost byte");
              for (let e of f) o = (o << 8) | e;
              if (((n += e), o < 128))
                throw new r("tlv.decode(long): not minimal encoding");
            } else o = i;
            let f = t.subarray(n, n + o);
            if (f.length !== o) throw new r("tlv.decode: wrong value length");
            return { v: f, l: t.subarray(n + o) };
          },
        },
        _int: {
          encode(e) {
        ...
        toSig(e) {
          let { Err: t, _int: r, _tlv: n } = ec,
            i = S("signature", e),
            { v: o, l: f } = n.decode(48, i);
          if (f.length)
            throw new t("invalid signature: left bytes after parsing");
          let { v: l, l: a } = n.decode(2, o),
            { v: u, l: s } = n.decode(2, a);
          if (s.length)
            throw new t("invalid signature: left bytes after parsing");
    ...
    function eE(e, t, r) {
      ...
      let { p: i, k: o, m: f, hash: l, expand: a, DST: u } = r;
      d(e), eb(t);
      let s = "string" == typeof u ? O(u) : u,
      ...
      if ("xmd" === a)
        n = (function (e, t, r, n) {
          d(e),
            d(t),
            eb(r),
            t.length > 255 && (t = n(A(O("H2C-OVERSIZE-DST-"), t)));
          let { outputLen: i, blockLen: o } = n,
            f = Math.ceil(r / i);
          if (r > 65535 || f > 255)
            throw Error("expand_message_xmd: invalid lenInBytes");
          let l = A(t, ew(t.length, 1)),
            a = ew(0, o),
            u = ew(r, 2),
            s = Array(f),
            c = n(A(a, e, u, ew(0, 1), l));
          s[0] = n(A(c, ew(1, 1), l));
          for (let e = 1; e <= f; e++) {
            let t = [
              (function (e, t) {
          ...
          return A(...s).slice(0, r);
        })(e, s, h, l);
      else if ("xof" === a)
        n = (function (e, t, r, n, i) {
          if ((d(e), d(t), eb(r), t.length > 255)) {
            let e = Math.ceil((2 * n) / 8);
            t = i
              .create({ dkLen: e })
              .update(O("H2C-OVERSIZE-DST-"))
              .update(t)
              .digest();
          }
          ...
          return i
            ...
            .update(ew(r, 2))
            .update(t)
            .update(ew(t.length, 1))
            .digest();
        })(e, s, h, o, l);
      else if ("_internal_pass" === a) n = e;
    ...
    function eI(e) {
      let t = BigInt(3),
        ...
        E = (K(b, r, ev) * a) % ev,
        v = K(E, eA, ev);
      if (!eR.eql(eR.sqr(v), e)) throw Error("Cannot find square root");
      return v;
    }
    let eR = Q(ev, void 0, void 0, { sqrt: eI }),
      eq =
        ((n = {
          a: ex,
          b: BigInt(7),
          ...
          endo: {
            ...
            splitScalar: (e) => {
              let t = BigInt("0x3086d221a7d46bcde86c90e49284eb15"),
                r = -eS * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"),
                ...
                u = l > i,
                s = a > i;
              if ((u && (l = eB - l), s && (a = eB - a), l > i || a > i))
                throw Error("splitScalar: Endomorphism failed, k=" + e);
              return { k1neg: u, k1: l, k2neg: s, k2: a };
            },
          },
        }),
        (i = o.sha256),
          ...
          ...(t = (e) =>
            (function (e) {
              let t,
                ...
                { Fp: n, n: i, nByteLength: o, nBitLength: f } = r,
                l = n.BYTES + 1,
                d = 2 * n.BYTES + 1;
              function h(e) {
                return k(e, i);
              ...
              let {
                  ...
                  function l(e) {
                    let { a: t, b: i } = r,
                      o = n.sqr(e),
                      f = n.mul(o, e);
                    return n.add(n.add(f, n.mul(e, t)), i);
                  }
                  function d(e, t) {
                    let r = n.sqr(t),
                      i = l(e);
                  ...
                  function m(e) {
                    ...
                    try {
                      t = "bigint" == typeof e ? e : E(S("private key", e, i));
                    } catch (t) {
                      throw Error(
                    ...
                    return o && (t = k(t, f)), q("private key", t, eg, f), t;
                  }
                  function p(e) {
                    if (!(e instanceof v))
                  ...
                  let w = Z((e, t) => {
                      ...
                      let f = e.is0();
                      null == t && (t = f ? n.ONE : n.inv(o));
                      let l = n.mul(r, t),
                        a = n.mul(i, t),
                        u = n.mul(o, t);
                      if (f) return { x: n.ZERO, y: n.ZERO };
                  ...
                  class v {
                    ...
                    static fromHex(e) {
                      let t = v.fromAffine(f(S("pointHex", e)));
                    ...
                    equals(e) {
                      ...
                      let { px: t, py: r, pz: i } = this,
                        { px: o, py: f, pz: l } = e,
                        a = n.eql(n.mul(t, l), n.mul(o, i)),
                        u = n.eql(n.mul(r, l), n.mul(f, i));
                      return a && u;
                    }
                    negate() {
                    ...
                    multiplyUnsafe(e) {
                      ...
                      let o = v.ZERO;
                      if (e === eh) return o;
                      if (this.is0() || e === eg) return this;
                      if (!t || O.hasPrecomputes(this))
                        return O.wNAFCachedUnsafe(this, e, v.normalizeZ);
                      let {
                          k1neg: f,
                          k1: l,
                          k2neg: a,
                      ...
                      return (
                        f && (s = s.negate()),
                        a && (d = d.negate()),
                        (d = new v(n.mul(d.px, t.beta), d.py, d.pz)),
                        s.add(d)
                      );
                    }
                    multiply(e) {
                    ...
                    toHex(e = !0) {
                      return c("isCompressed", e), y(this.toRawBytes(e));
                    }
                  }
                    ...
                    O =
                      ((t = B ? Math.ceil(x / 2) : x),
                      {
                        ...
                        wNAFUnsafe(e, r, n, i = v.ZERO) {
                          let o = eo(e, t);
                          for (let e = 0; e < o.windows && n !== et; e++) {
                            let {
                              nextN: t,
                              offset: f,
                              isZero: l,
              ...
              class I {
                ...
                static fromCompact(e) {
                  return new I(
                    O((e = S("compactSignature", e, 2 * o)), 0, o),
                    O(e, o, 2 * o)
                  );
                }
                static fromDER(e) {
                  let { r: t, s: r } = ec.toSig(S("DER", e));
                  return new I(t, r);
                }
                assertValidity() {}
                addRecoveryBit(e) {
                ...
                recoverPublicKey(e) {
                  let { r: t, s: o, recovery: f } = this,
                    l = D(S("msgHash", e));
                  if (null == f || ![0, 1, 2, 3].includes(f))
                    throw Error("recovery id invalid");
                  let a = 2 === f || 3 === f ? t + r.n : t;
                  if (a >= n.ORDER) throw Error("recovery id 2 or 3 invalid");
                  let u = (1 & f) == 0 ? "02" : "03",
                    s = g.fromHex(u + y(B(a, n.BYTES))),
                    d = L(a, i),
                    c = h(-l * d),
                    m = h(o * d),
                    p = g.BASE.multiplyAndAddUnsafe(s, c, m);
                ...
                toCompactHex() {
                  return y(B(this.r, o)) + y(B(this.s, o));
                }
              }
              function P(e) {
                if ("bigint" == typeof e) return !1;
                if (e instanceof g) return !0;
                let t = S("key", e).length,
                  i = n.BYTES,
                  f = i + 1;
                if (!r.allowedPrivateKeyLengths && o !== f)
                  return t === f || t === 2 * i + 1;
              }
              let C =
                  r.bits2int ||
                ...
                F = N(f);
              function V(e) {
                return q("num < 2^" + f, e, eh, F), B(e, o);
              }
              let _ = { lowS: r.lowS, prehash: !1 },
                H = { lowS: r.lowS, prehash: !1 };
              return (
                g.BASE._setWindowSize(8),
                {
                  ...
                  getSharedSecret: function (e, t, r = !0) {
                    ...
                    return g.fromHex(t).multiply(m(e)).toRawBytes(r);
                  },
                  sign: function (e, t, o = _) {
                    let { seed: f, k2sig: l } = (function (e, t, o = _) {
                      if (["recovered", "canonical"].some((e) => e in o))
                        throw Error("sign() legacy options not supported");
                      let { hash: f, randomBytes: l } = r,
                        { lowS: a, prehash: u, extraEntropy: s } = o;
                      null == a && (a = !0),
                        (e = S("msgHash", e)),
                        ed(o),
                        u && (e = S("prehashed msgHash", f(e)));
                      let d = D(e),
                        c = m(t),
                        p = [V(c), V(d)];
                      if (null != s && !1 !== s) {
                        let e = !0 === s ? l(n.BYTES) : s;
                        p.push(S("extraEntropy", e));
                      }
                      return {
                        seed: A(...p),
                        k2sig: function (e) {
                          ...
                          if (!w(r)) return;
                          let n = L(r, i),
                            o = g.BASE.multiply(r).toAffine(),
                            f = h(o.x);
                          if (f === eh) return;
                          let l = h(n * h(d + f * c));
                          if (l === eh) return;
                          let u = (2 * (o.x !== f)) | Number(o.y & eg),
                            s = l;
                          return (
                            a &&
                              l > i >> eg &&
                              ((s = (t = l) > i >> eg ? h(-t) : t), (u ^= 1)),
                            new I(f, s, u)
                          );
                        },
                      };
                  ...
                  verify: function (e, t, n, o = H) {
                    let f, l;
                    (t = S("msgHash", t)), (n = S("publicKey", n));
                    let { lowS: a, prehash: u, format: d } = o;
                    if ((ed(o), "strict" in o))
                      throw Error("options.strict was renamed to lowS");
                    if (void 0 !== d && "compact" !== d && "der" !== d)
                      throw Error("format must be compact or der");
                    let c = "string" == typeof e || s(e),
                      m =
                        !c &&
                        !d &&
                        "object" == typeof e &&
                    ...
                    try {
                      if ((m && (l = new I(e.r, e.s)), c)) {
                        try {
                          "compact" !== d && (l = I.fromDER(e));
                        } catch (e) {
                          if (!(e instanceof ec.Err)) throw e;
                        }
                        l || "der" === d || (l = I.fromCompact(e));
                      }
                      f = g.fromHex(n);
                    } catch (e) {
                      return !1;
                    }
                    if (!l || (a && l.hasHighS())) return !1;
                    u && (t = r.hash(t));
                    let { r: p, s: y } = l,
                      w = D(t),
                      b = L(y, i),
                      E = h(w * b),
                      v = h(p * b),
                      B = g.BASE.multiplyAndAddUnsafe(f, E, v)?.toAffine();
                    return !!B && h(B.x) === p;
                  },
                  ProjectivePoint: g,
                  Signature: I,
                  utils: {
                    ...
                    randomPrivateKey: () => {
                      ...
                      return (function (e, t, r = !1) {
                        ...
                        let f = k(r ? v(e) : E(e), t - z) + z;
                        return r ? x(f, i) : B(f, i);
                      })(r.randomBytes(e), r.n);
                    },
              ...
              ...{
                hash: e,
                hmac: (t, ...r) => (0, l.hmac)(e, t, (0, f.concatBytes)(...r)),
    ...
    function eT(e, ...t) {
      ...
      return (0, o.sha256)(A(r, ...t));
    }
    let eP = (e) => e.toRawBytes(!0).slice(1),
      eU = eq.ProjectivePoint;
    function eZ(e) {
      let t = eq.utils.normPrivateKeyToScalar(e),
        r = eU.fromPrivateKey(t);
      return { scalar: r.hasEvenY() ? t : k(-t, eB), bytes: eP(r) };
    }
    function eC(e) {
      q("x", e, eS, ev);
      let t = k(e * e, ev),
        r = eI(k(t * e + BigInt(7), ev));
      r % eA !== ex && (r = k(-r, ev));
      let n = new eU(e, r, eS);
      return n.assertValidity(), n;
    }
    function ez(...e) {
      return k(E(eT("BIP0340/challenge", ...e)), eB);
    }
    function eD(e, t, r) {
      let n = S("signature", e, 64),
        i = S("message", t),
        o = S("publicKey", r, 32);
      try {
        let e,
          ...
          r = eC(E(o)),
          f = E(n.subarray(0, 32));
        if (!R(f, eS, ev)) return !1;
        let l = E(n.subarray(32, 64));
        if (!R(l, eS, eB)) return !1;
        let a = ez(B(f, 32), eP(r), i),
          u = ((e = -a), (t = k(e, eB)), eU.BASE.multiplyAndAddUnsafe(r, l, t));
        if (!u || !u.hasEvenY() || u.toAffine().x !== f) return !1;
        return !0;
      } catch (e) {
        return !1;
      }
    ...
    let eF = {
        ...
        sign: function (e, t, r = (0, f.randomBytes)(32)) {
          let n = S("message", e),
            { bytes: i, scalar: o } = eZ(t),
            l = B(o ^ E(eT("BIP0340/aux", S("auxRand", r, 32))), 32),
            a = k(E(eT("BIP0340/nonce", l, i, n)), eB);
          if (a === ex) throw Error("sign failed: k is zero");
          let { bytes: u, scalar: s } = eZ(a),
            d = ez(u, i, n),
            c = new Uint8Array(64);
          if ((c.set(u, 0), c.set(B(k(s + d * o, eB), 32), 32), !eD(c, n, i)))
            throw Error("sign: Invalid signature produced");
          return c;
        },
        verify: eD,
        utils: {
          randomPrivateKey: eq.utils.randomPrivateKey,
          lift_x: eC,
          pointToBytes: eP,
          numberToBytesBE: B,
          bytesToNumberBE: E,
      ...
      eV =
        ...
        (e, t) => {
          let [n, i, o, f] = r.map((t) =>
              t.reduce((t, r) => eR.add(eR.mul(t, e), r))
            ),
            [l, a] = G(eR, [i, f], !0);
          return (
            (e = eR.mul(n, l)), (t = eR.mul(t, eR.mul(o, a))), { x: e, y: t }
          );
        }),
      e_ = (function (e, t) {
        if ((W(e), !e.isValid(t.A) || !e.isValid(t.B) || !e.isValid(t.Z)))
          throw Error("mapToCurveSimpleSWU: invalid opts");
        let r = (function (e, t) {
          let r = e.ORDER,
            n = eh;
          for (let e = r - eg; e % em === eh; e /= em) n += eg;
          let i = n,
            o = em << (i - eg - eg),
            f = o * em,
            l = (r - eg) / f,
        ...
        return (n) => {
          ...
          (i = e.sqr(n)),
            ...
            (o = e.add(o, a)),
            (s = e.mul(i, f));
          let { isValid: c, value: h } = r(o, u);
          (d = e.mul(i, n)),
            (d = e.mul(d, h)),
            (s = e.cmov(s, f, c)),
            (d = e.cmov(d, h, c));
          let g = e.isOdd(n) === e.isOdd(d);
          d = e.cmov(e.neg(d), d, g);
          let m = G(e, [l], !0)[0];
          return { x: (s = e.mul(s, m)), y: d };
        };
      })(eR, {
        A: BigInt(
      ...
      eH = (function (e, t, r) {
        ...
        return {
          defaults: r,
          hashToCurve(e, t) {
            let o = eE(e, 2, { ...r, DST: r.DST, ...t }),
              f = n(o[0]),
              l = n(o[1]);
            return i(f.add(l));
          },
          encodeToCurve: (e, t) =>
            i(n(eE(e, 1, { ...r, DST: r.encodeDST, ...t })[0])),
          mapToCurve(e) {
