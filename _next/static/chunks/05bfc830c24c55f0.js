(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function l(e) {
      return f((0, t.bytesToHex)(e));
    }
    function u(e) {
      return (
        (0, t.abytes)(e), f((0, t.bytesToHex)(Uint8Array.from(e).reverse()))
      );
    }
    function d(e, r) {
    ...
    function $(e) {
      if (e < _) throw Error("sqrt is not defined for small field");
      let t = e - F,
        r = 0;
      for (; t % U === N; ) (t /= U), r++;
      let n = U,
      ...
      return function (e, n) {
        ...
        for (; !e.eql(f, e.ONE); ) {
          ...
          let n = F << BigInt(i - t - 1),
            o = e.pow(a, n);
          (i = t), (a = e.sqr(o)), (f = e.mul(f, a)), (l = e.mul(l, o));
        }
        return l;
      };
    }
    ...
    function J(e, r) {
      ...
      let n = void 0 !== r ? r : e.toString(2).length,
        i = Math.ceil(n / 8);
    ...
    function Q(e, t, r = !1, n = {}) {
      ...
      if ("object" == typeof t && null != t) {
        ...
        t.BITS && (o = t.BITS),
          ...
          "boolean" == typeof t.modFromBytes && (f = t.modFromBytes),
          (a = t.allowedLengths);
      } else "number" == typeof t && (o = t), n.sqrt && (s = n.sqrt);
      let { nBitLength: h, nByteLength: m } = J(e, o);
      if (m > 2048)
      ...
      let y = Object.freeze({
        ...
        is0: (e) => e === N,
        isValidNot0: (e) => !y.is0(e) && y.isValid(e),
        isOdd: (e) => (e & F) === F,
        neg: (t) => P(-t, e),
        eql: (e, t) => e === t,
        sqr: (t) => P(t * t, e),
                  ...
                  return (
                    ...
                    (e, t) => {
                      let r = e.pow(t, s),
                        ...
                        u = e.eql(e.sqr(a), t),
                        d = e.eql(e.sqr(f), t);
                      (r = e.cmov(r, a, u)), (a = e.cmov(l, f, d));
                      let c = e.eql(e.sqr(a), t),
                        h = e.cmov(r, a, c);
                      return M(e, h, t), h;
                    }
                  );
        ...
        toBytes: (e) => (r ? c(e, m) : d(e, m)),
        fromBytes: (t, n = !0) => {
          if (a) {
            if (!a.includes(t.length) || t.length > m)
              throw Error(
    ...
    function en(e, t, r = !1) {
      ...
      let s = P(r ? u(e) : l(e), t - F) + F;
      return r ? c(s, i) : d(s, i);
    }
    e.s(
      [
        "Field",
    ...
    function em(e) {
      if (e !== ei) throw Error("invalid wNAF");
    }
    class ey {
      constructor(e, t) {
        (this.BASE = e.BASE),
      ...
      _unsafeLadder(e, t, r = this.ZERO) {
        let n = e;
        for (; t > ei; ) t & eo && (r = r.add(n)), (n = n.double()), (t >>= eo);
        return r;
      }
      precomputeWindow(e, t) {
        let { windows: r, windowSize: n } = el(t, this.bits),
          i = [],
          o = e,
          s = o;
        for (let e = 0; e < r; e++) {
      ...
      wNAF(e, t, r) {
        ...
        for (let e = 0; e < o.windows; e++) {
          ...
          (r = s), f ? (i = i.add(es(u, t[d]))) : (n = n.add(es(l, t[a])));
        }
        return em(r), { p: n, f: i };
      }
      wNAFUnsafe(e, t, r, n = this.ZERO) {
        let i = el(e, this.bits);
        for (let e = 0; e < i.windows && r !== ei; e++) {
          let { nextN: o, offset: s, isZero: a, isNeg: f } = eu(r, e, i);
          if (((r = o), !a)) {
            let e = t[s];
      ...
      getPrecomputes(e, t, r) {
        ...
        return (
          n ||
            ...
            1 !== e && ("function" == typeof r && (n = r(n)), ed.set(t, n))),
          n
        );
      }
      cached(e, t, r) {
      ...
      createCache(e, t) {
        ef(t, this.bits), ec.set(e, t), ed.delete(e);
      }
      hasCache(e) {
        return 1 !== eh(e);
      }
    ...
    function eb(e, t, r, n) {
      ...
      let l = O(f),
        u = Array(Number(l) + 1).fill(s),
        d = Math.floor((t.BITS - 1) / f) * f,
        c = s;
      for (let e = d; e >= 0; e -= f) {
        u.fill(s);
        for (let t = 0; t < o; t++) {
  ...
  (e) => {
    ...
    function f(e, t, n, i) {
      ...
      let { outputLen: f, blockLen: l } = i,
        u = Math.ceil(n / f);
      if (n > 65535 || u > 255)
        throw Error("expand_message_xmd: invalid lenInBytes");
      let d = (0, r.concatBytes)(t, o(t.length, 1)),
        c = o(0, l),
        h = o(n, 2),
        m = Array(u),
        y = i((0, r.concatBytes)(c, e, h, o(0, 1), d));
      m[0] = i((0, r.concatBytes)(y, o(1, 1), d));
      for (let e = 1; e <= u; e++) {
        let t = [
          (function (e, t) {
    ...
    function l(e, l, u) {
      let d;
      (0, t._validateObject)(u, {
        p: "bigint",
        m: "number",
        k: "number",
        hash: "function",
      });
      let { p: c, k: h, m, hash: y, expand: p, DST: b } = u;
      if (!(0, t.isHash)(u.hash)) throw Error("expected valid hash");
      (0, r.abytes)(e), s(l);
      let g = Math.ceil((c.toString(2).length + h) / 8),
        w = l * m * g;
      if ("xmd" === p) d = f(e, b, w, y);
      else if ("xof" === p)
        d = (function (e, t, n, i, f) {
    ...
    function u(e, t) {
      ...
      return (t, i) => {
        let [o, s, a, f] = r.map((r) =>
          ...
          [l, u] = (0, n.FpInvertBatch)(e, [s, f], !0);
        return (t = e.mul(o, l)), (i = e.mul(i, e.mul(a, u))), { x: t, y: i };
      };
    }
    let d = (0, r.utf8ToBytes)("HashToScalar-");
    function c(e, t, r) {
      ...
      return {
        ...
        hashToScalar: (t, n) =>
          l(
            t,
            1,
            Object.assign({}, r, { p: e.Fn.ORDER, m: 1, DST: d }, n)
          )[0][0],
      };
    }
    e.s([
  ...
  (e) => {
    ...
    let l = {
        ...
        toSig(e) {
          ...
          let { v: f, l: u } = i.decode(2, s),
            { v: d, l: c } = i.decode(2, u);
          if (c.length)
            throw new t("invalid signature: left bytes after parsing");
          return { r: r.decode(f), s: r.decode(d) };
        },
        hexFromSig(e) {
          let { _tlv: t, _int: r } = l,
    ...
    function b(e, t) {
      ...
      return (t) => {
        ...
        (a = e.sqr(t)),
          ...
          (l = e.add(f, e.ONE)),
          (l = e.mul(l, n)),
          (u = e.cmov(i, e.neg(f), !e.eql(f, e.ZERO))),
          (u = e.mul(u, r)),
          (f = e.sqr(l)),
          (c = e.sqr(u)),
          (d = e.mul(c, r)),
        ...
        let g = (0, o.FpInvertBatch)(e, [u], !0)[0];
        return { x: (h = e.mul(h, g)), y: m };
      };
    }
    function g(e, t) {
      return {
    ...
    function w(e) {
      let b,
        {
          ...
          return { CURVE: s, curveOpts: a, hash: e.hash, ecdsaOpts: f };
        })(e),
        x = (function (e, i, s = {}) {
          (0, r.ahash)(i),
            (0, n._validateObject)(
          ...
          let h = s.randomBytes || r.randomBytes,
            m =
              s.hmac ||
            ...
            { ORDER: E, BITS: B } = w,
            {
              ...
              function u(t, r = !0) {
                return e.BASE.multiply(y(i, t)).toBytes(r);
              }
              function d(t) {
                ...
                let f = (0, n.ensureBytes)("key", t).length;
                return f === o || f === s;
              }
              return Object.freeze({
                getPublicKey: u,
                getSharedSecret: function (t, r, n = !0) {
                  if (!0 === d(t)) throw Error("first arg must be private key");
                  if (!1 === d(r)) throw Error("second arg must be public key");
                  let o = y(i, t);
                  return e.fromHex(r).multiply(o).toBytes(n);
                },
                keygen: function (e) {
                  let t = l(e);
                  return { secretKey: t, publicKey: u(t) };
                },
                Point: e,
                utils: {
                  isValidSecretKey: f,
                  ...
                  isValidPrivateKey: f,
                  randomPrivateKey: l,
                  normPrivateKeyToScalar: (e) => y(i, e),
          ...
          class q {
            ...
            static fromBytes(e, t = T) {
              ...
              let f = w.BYTES,
                u = e.subarray(0, f),
                d = e.subarray(f, 2 * f);
              return new q(w.fromBytes(u), w.fromBytes(d), o);
            }
            static fromHex(e, t) {
              return this.fromBytes((0, r.hexToBytes)(e), t);
            }
            addRecoveryBit(e) {
              return new q(this.r, this.s, e);
            }
            recoverPublicKey(t) {
              let i = b.ORDER,
              ...
              let f = 2 === a || 3 === a ? o + E : o;
              if (!b.isValid(f)) throw Error("recovery id 2 or 3 invalid");
              let l = b.toBytes(f),
                u = e.fromBytes((0, r.concatBytes)(p((1 & a) == 0), l)),
                d = w.inv(f),
                h = F((0, n.ensureBytes)("msgHash", t)),
                m = w.create(-h * d),
                y = w.create(s * d),
                g = e.BASE.multiplyUnsafe(m).add(u.multiplyUnsafe(y));
            ...
            static fromCompact(e) {
              return q.fromBytes((0, n.ensureBytes)("sig", e), "compact");
            }
            static fromDER(e) {
              return q.fromBytes((0, n.ensureBytes)("sig", e), "der");
            }
            normalizeS() {
              return this.hasHighS()
                ? new q(this.r, w.neg(this.s), this.recovery)
                : this;
            }
            toDERRawBytes() {
          ...
          let N =
            ...
            U = (0, n.bitMask)(B);
          function _(e) {
            return (0, n.aInRange)("num < 2^" + B, e, u, U), w.toBytes(e);
          }
          function Z(e, t) {
            return (
          ...
          return Object.freeze({
            ...
            sign: function (t, o, s = {}) {
              let { seed: a, k2sig: l } = (function (t, i, o) {
                ...
                let { lowS: s, prehash: a, extraEntropy: l } = f(o, I),
                  c = F((t = Z(t, a))),
                  m = y(w, i),
                  p = [_(m), _(c)];
                if (null != l && !1 !== l) {
                  let e = !0 === l ? h(R.secretKey) : l;
                  p.push((0, n.ensureBytes)("extraEntropy", e));
                }
                return {
                  seed: (0, r.concatBytes)(...p),
                  k2sig: function (t) {
                    let r = N(t);
                    ...
                    let n = w.inv(r),
                      ...
                      o = w.create(i.x);
                    if (o === u) return;
                    let a = w.create(n * w.create(c + o * m));
                    if (a === u) return;
                    let f = (2 * (i.x !== o)) | Number(i.y & d),
                      l = a;
                    return (
                      s && a > E >> d && ((l = w.neg(a)), (f ^= 1)),
                      new q(o, l, f)
                    );
                  },
                };
              })((t = (0, n.ensureBytes)("message", t)), o, s);
              return (0, n.createHmacDrbg)(i.outputLen, w.BYTES, m)(a, l);
            },
            verify: function (t, i, o, s = {}) {
              let { lowS: a, prehash: u, format: d } = f(s, I);
              if (
                ((o = (0, n.ensureBytes)("publicKey", o)),
                (i = Z((0, n.ensureBytes)("message", i), u)),
                "strict" in s)
              )
              ...
              let c =
                void 0 === d
                  ? (function (e) {
                      ...
                      if (o) t = new q(e.r, e.s);
                      else if (i) {
                        try {
                          t = q.fromBytes((0, n.ensureBytes)("sig", e), "der");
                        } catch (e) {
                  ...
                  : q.fromBytes((0, n.ensureBytes)("sig", t), d);
              if (!1 === c) return !1;
              try {
                let t = e.fromBytes(o);
                if (a && c.hasHighS()) return !1;
                let { r, s: n } = c,
                  s = F(i),
                  f = w.inv(n),
                  l = w.create(s * f),
                  u = w.create(r * f),
                  d = e.BASE.multiplyUnsafe(l).add(t.multiplyUnsafe(u));
                if (d.is0()) return !1;
                return w.create(d.x) === r;
              } catch (e) {
                return !1;
              }
            },
            recoverPublicKey: function (e, t, r = {}) {
              ...
              return (
                (t = Z(t, n)),
                q.fromBytes(e, "recovered").recoverPublicKey(t).toBytes()
              );
            },
            Signature: q,
            hash: i,
          ...
          (function (e, t = {}) {
            ...
            if (
              w &&
              (!a.is0(l.a) ||
                "bigint" != typeof w.beta ||
                !Array.isArray(w.basises))
            )
              throw Error(
            ...
            let v =
              ...
              x =
                ...
                function (e) {
                  ...
                  let { publicKey: t, publicKeyUncompressed: r } = E,
                    i = e.length,
                    o = e[0],
                    s = e.subarray(1);
                  if (i === t && (2 === o || 3 === o)) {
            ...
            let R = a.mul(a.pow(l.a, h), m),
              I = a.mul(a.sqr(l.b), BigInt(27));
            if (a.is0(a.add(R, I))) throw Error("bad curve params: a or b");
            function T(e, t, r = !1) {
            ...
            function A(e) {
              if (!(e instanceof _)) throw Error("ProjectivePoint expected");
            }
            function q(e) {
              if (!w || !w.basises) throw Error("no endo");
              return (function (e, t, r) {
                ...
                return { k1neg: y, k1: h, k2neg: p, k2: m };
              })(e, w.basises, f.ORDER);
            }
            let N = (0, n.memoized)((e, t) => {
                let { X: r, Y: n, Z: i } = e;
            ...
            class _ {
              ...
              static fromAffine(e) {
                ...
                if (e instanceof _) throw Error("projective point not allowed");
                return a.is0(t) && a.is0(r) ? _.ZERO : new _(t, r, a.ONE);
              }
              static fromBytes(e) {
                let t = _.fromAffine(x((0, n._abytes2)(e, void 0, "point")));
                return t.assertValidity(), t;
              }
              static fromHex(e) {
                return _.fromBytes((0, n.ensureBytes)("pointHex", e));
              }
              get x() {
              ...
              precompute(e = 8, t = !0) {
                return C.createCache(this, e), t || this.multiply(h), this;
              }
              assertValidity() {
                F(this);
              }
              ...
              equals(e) {
                ...
                let { X: t, Y: r, Z: n } = this,
                  { X: i, Y: o, Z: s } = e,
                  f = a.eql(a.mul(t, s), a.mul(i, n)),
                  l = a.eql(a.mul(r, s), a.mul(o, n));
                return f && l;
              }
              negate() {
                return new _(this.X, a.neg(this.Y), this.Z);
              }
              double() {
                let { a: e, b: t } = l,
                  r = a.mul(t, h),
              ...
              multiply(e) {
                ...
                let s = (e) =>
                  C.cached(this, e, (e) => (0, i.normalizeZ)(_, e));
                if (o) {
                  let { k1neg: t, k1: i, k2neg: a, k2: f } = q(e),
                    { p: l, f: u } = s(i),
                    { p: d, f: c } = s(f);
                  (n = u.add(c)), (r = U(o.beta, l, d, t, a));
                } else {
                  let { p: t, f: i } = s(e);
                  (r = t), (n = i);
                }
                return (0, i.normalizeZ)(_, [r, n])[0];
              }
              multiplyUnsafe(e) {
                let { endo: r } = t;
                if (!f.isValid(e)) throw Error("invalid scalar: out of range");
                if (e === u || this.is0()) return _.ZERO;
                if (e === d) return this;
                if (C.hasCache(this)) return this.multiply(e);
                if (!r) return C.unsafe(this, e);
                {
                  let { k1neg: t, k1: n, k2neg: o, k2: s } = q(e),
                    { p1: a, p2: f } = (0, i.mulEndoUnsafe)(_, this, n, s);
                  return U(r.beta, a, f, t, o);
                }
              }
              ...
              isTorsionFree() {
                ...
                return c === d || (e ? e(_, this) : C.unsafe(this, b).is0());
              }
              clearCofactor() {
                let { clearCofactor: e } = t;
                return c === d ? this : e ? e(_, this) : this.multiplyUnsafe(c);
              }
              isSmallOrder() {
              ...
              static normalizeZ(e) {
                return (0, i.normalizeZ)(_, e);
              }
              static msm(e, t) {
                return (0, i.pippenger)(_, f, e, t);
              }
              static fromPrivateKey(e) {
                return _.BASE.multiply(y(f, e));
              }
            }
            (_.BASE = new _(l.Gx, l.Gy, a.ONE)),
              (_.ZERO = new _(a.ZERO, a.ONE, a.ZERO)),
              (_.Fp = a),
              (_.Fn = f);
            let Z = f.BITS,
              C = new i.wNAF(_, t.endo ? Math.ceil(Z / 2) : Z);
      ...
      return (
        ...
        Object.assign({}, x, {
          ProjectivePoint: b,
          CURVE: Object.assign({}, e, (0, o.nLength)(b.Fn.ORDER, b.Fn.BITS)),
        })
      );
    }
    function E(e, t) {
  ...
  (e) => {
    ...
    let f = {
      ...
      c = (0, o.Field)(f.p, {
        sqrt: function (e) {
          let t = f.p,
            ...
            h = (e * e * e) % t,
            m = (h * h * e) % t,
            y = ((0, o.pow2)(m, r, t) * m) % t,
            p = ((0, o.pow2)(y, r, t) * m) % t,
            b = ((0, o.pow2)(p, d, t) * h) % t,
            g = ((0, o.pow2)(b, i, t) * b) % t,
            w = ((0, o.pow2)(g, s, t) * g) % t,
            E = ((0, o.pow2)(w, l, t) * w) % t,
            B = ((0, o.pow2)(E, u, t) * E) % t,
            v = ((0, o.pow2)(B, l, t) * w) % t,
            x = ((0, o.pow2)(v, r, t) * m) % t,
            O = ((0, o.pow2)(x, a, t) * g) % t,
      ...
      h = (0, n.createCurve)({ ...f, Fp: c, lowS: !0, endo: l }, t.sha256);
    h.Point;
    a.bytesToNumberBE;
