(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let i = e.r(954839),
      ...
      a = u[i.OUTLET_BOUNDARY_NAME.slice(0)],
  ...
  (e, t, r) => {
    ...
    for (var o in n) Object.defineProperty(r, o, { enumerable: !0, get: n[o] });
    function i() {
      return "dpl_25b3Mzhw2NrBCqvSkfMGMSu9iK44";
    }
    function u() {
      let e = i();
      return `?dpl=${e}`;
          ...
          (o.nextTick = function (e) {
            ...
            if (arguments.length > 1)
              for (var r = 1; r < arguments.length; r++)
                t[r - 1] = arguments[r];
            l.push(new p(e, t)), 1 !== l.length || a || s(d);
          }),
        ...
        !(function e(t, r, n, u, s) {
          ...
          if (T(t))
            ...
            for (t = _.call(t), _ = 0; !(u = t.next()).done; )
              (f = p + C((u = u.value), _++)), (d += e(u, r, n, f, s));
          else if ("object" === f) {
