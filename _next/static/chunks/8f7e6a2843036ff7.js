(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let v = (e) => (t) => {
          ...
          let m = () => {
            ...
            let r =
              (null == (n = s.onRehydrateStorage)
                ? void 0
                : n.call(s, null != (t = a()) ? t : p)) || void 0;
            return v(l.getItem.bind(l))(s.name)
              .then((e) => {
                if (e)
              ...
              .then((t) => {
                var n;
                let [r, o] = t;
                if ((e((i = s.merge(o, null != (n = a()) ? n : p)), !0), r))
                  return d();
              })
              .then(() => {
                null == r || r(i, void 0),
      ...
      S = Object.assign(Object.assign({}, k), {
        subAccounts: {
      ...
      I = "0xf85210B21cC50302F477BA56686d2019dC9b67Ad",
      T = [
    ...
    function Q(e, t) {
      let [n, a] = Y(t);
      return new G(e, n || D(e), a);
    }
    function X(e, t) {
      let [n, a] = Y(t);
      return new _(e, n || D(e), a);
    }
    function Y(e) {
      if (e) {
    ...
    function et(e, t, n) {
      if (null == e)
        throw null != t
          ? t
          : L({ message: null != n ? n : "value must be present", data: e });
    }
    function en(e, t) {
      if (!Array.isArray(e))
        throw L({ message: null != t ? t : "value must be an array", data: e });
    }
    let ea = `Base Account SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Base Account app.

Please see https://docs.base.org/smart-wallet/quickstart#cross-origin-opener-policy for more information.`,
      { checkCrossOriginOpenerPolicy: er, getCrossOriginOpenerPolicy: ei } = {
        getCrossOriginOpenerPolicy: () => (void 0 === a ? "undefined" : a),
        checkCrossOriginOpenerPolicy: async () => {
          ...
          try {
            ...
            (a = null != n ? n : "null"),
              "same-origin" === a && console.error(ea);
          } catch (e) {
            console.error(
        ...
        (null == (a = window.ClientAnalytics) ||
          a.logEvent(
            ...
            Object.assign(Object.assign({}, t), {
              ...
              appName:
                null !=
                (i = null == (r = S.config.get().metadata) ? void 0 : r.appName)
                  ? i
                  : "",
    ...
    ((s = d || (d = {})).unknown = "unknown"),
      (s.banner = "banner"),
      (s.button = "button"),
      (s.card = "card"),
      (s.chart = "chart"),
      (s.content_script = "content_script"),
      (s.dropdown = "dropdown"),
      (s.link = "link"),
      (s.page = "page"),
      (s.modal = "modal"),
      (s.table = "table"),
      (s.search_bar = "search_bar"),
      (s.service_worker = "service_worker"),
      (s.text = "text"),
      (s.text_input = "text_input"),
      (s.tray = "tray"),
      (s.checkbox = "checkbox"),
      (s.icon = "icon"),
      ((o = f || (f = {})).unknown = "unknown"),
      (o.blur = "blur"),
      (o.click = "click"),
      (o.change = "change"),
      (o.dismiss = "dismiss"),
      ...
      ((c = p || (p = {})).low = "low"),
      (c.high = "high");
    let ed = ({ dialogContext: e }) => {
        el(
          `dialog.${e}.shown`,
          { action: f.render, componentType: d.modal, dialogContext: e },
          p.high
        );
      },
      ef = ({ dialogContext: e }) => {
        el(
          `dialog.${e}.dismissed`,
          { action: f.dismiss, componentType: d.modal, dialogContext: e },
          p.high
        );
      },
      ep = ({ dialogContext: e, dialogAction: t }) => {
        el(
...
`,
    ...
    let eA = () => {
      let [e, t] = (0, ex.useState)(!1);
      return ((0, ex.useEffect)(() => {
        let e = () => {
          t(ek());
        };
        return (
      ...
      e)
        ? (0, eg.jsx)("div", { class: "-base-acc-sdk-dialog-handle-bar" })
        : null;
    };
    class eS {
      constructor() {
      ...
      clear() {
        this.items.clear(), this.root && (0, eb.render)(null, this.root);
      }
      render() {
        this.root &&
          (0, eb.render)(
            (0, eg.jsx)("div", {
              children: (0, eg.jsx)(eI, {
    ...
    let eI = (e) => {
        let [t, n] = (0, ex.useState)(0),
          [a, r] = (0, ex.useState)(!1),
          [i, s] = (0, ex.useState)(0);
        return (0, eg.jsxs)("div", {
          class: (0, ey.clsx)("-base-acc-sdk-dialog-container"),
          children: [
            (0, eg.jsx)("style", {
              children:
            ...
            (0, eg.jsx)("div", {
              ...
              children: (0, eg.jsxs)("div", {
                ...
                children: [(0, eg.jsx)(eA, {}), e.children],
              }),
            }),
          ],
        });
      },
      eT = ({ title: e, message: t, actionItems: n, handleClose: a }) => {
        let [r, i] = (0, ex.useState)(!0),
          [s, o] = (0, ex.useState)(!0),
          [c, u] = (0, ex.useState)(null);
        (0, ex.useEffect)(() => {
          ...
          (0, ex.useEffect)(() => {
            (async () => {
              var e;
              let t = null == (e = S.account.get().accounts) ? void 0 : e[0];
              t && u(await ev(t)), o(!1);
            })();
          }, []);
        let l = (0, ex.useMemo)(
          () => (c ? `Signed in as ${c}` : "Base Account"),
          [c]
        );
        return (0, eg.jsxs)("div", {
          class: (0, ey.clsx)(
    ...
    function eO() {
      ...
      return (
        !(function () {
          if (document.head.querySelector(`style[base-sdk-font="${eh}"]`))
            return;
          let e = document.createElement("style");
          e.setAttribute("base-sdk-font", eh),
            (e.textContent = em),
          ...
          (this.waitForPopupLoaded = async () =>
            this.popup && !this.popup.closed
              ...
              : (el(
                  ...
                  { action: f.unknown, componentType: d.unknown },
                  p.high
                ),
                (this.popup = await (function (e) {
                  let t,
                    n,
                    a = (window.innerWidth - 420) / 2 + window.screenX,
                    r = (window.innerHeight - 700) / 2 + window.screenY;
                  function i() {
                    let t = `wallet_${crypto.randomUUID()}`,
                      n = window.open(
                        e,
                        t,
                        `width=420, height=700, left=${a}, top=${r}`
                      );
                  ...
                  return l
                    ...
                    : ((s = i),
                      ...
                      (n = eO()),
                      new Promise((e, a) => {
                        ed({ dialogContext: "popup_blocked" }),
                          n.presentItem({
                            title:
                            ...
                            actionItems: [
                              {
                                ...
                                onClick: () => {
                                  ...
                                  let t = s();
                                  t ? e(t) : a(F("Popup window was blocked")),
                                    n.clear();
                                },
                              },
                              {
    ...
    function eD(e, t = !1) {
      if ("string" == typeof e) {
        let n = eR(e).toLowerCase();
        if (eB.test(n)) return t ? `0x${n}` : n;
      }
      throw L(`"${String(e)}" is not a hexadecimal string`);
    }
    var eK = e.i(450323),
      eq = e.i(806685);
    let eH = (e) =>
    ...
    function eV(e) {
      e.forEach((e) => {
        ...
        let u = (0, eF.defineChain)({
            ...
            nativeCurrency: {
              name:
                null != (r = null == (a = e.nativeCurrency) ? void 0 : a.name)
                  ? r
                  : "",
              symbol:
                null != (s = null == (i = e.nativeCurrency) ? void 0 : i.symbol)
                  ? s
                  : "",
              decimals:
                null !=
          ...
          l = (0, eL.createPublicClient)({
            chain: u,
            transport: (0, ez.http)(e.rpcUrl),
          }),
          d = (0, eW.createBundlerClient)({
            client: l,
            transport: (0, ez.http)(e.rpcUrl),
          });
        eZ.setState({ [e.id]: { client: l, bundlerClient: d } });
      });
    }
    function eJ(e) {
      var t;
      return null == (t = eZ.getState()[e]) ? void 0 : t.client;
    }
    let eQ = x(() => ({ correlationIds: new Map() })),
      eX = (e) => eQ.getState().correlationIds.get(e);
    var eY = e.i(796516),
      eG = e.i(880841);
    function e_(e) {
      if ("object" != typeof e || null === e)
        throw F("sub account info is not an object");
      if (!("address" in e)) throw F("sub account is invalid");
      if (
        "address" in e &&
        "string" == typeof e.address &&
        !(0, eY.isAddress)(e.address)
      )
        throw F("sub account address is invalid");
      if (
        "factory" in e &&
        "string" == typeof e.factory &&
        !(0, eY.isAddress)(e.factory)
      )
        throw F("sub account factory address is invalid");
      if (
        "factoryData" in e &&
        "string" == typeof e.factoryData &&
        !(0, eG.isHex)(e.factoryData)
      )
        throw F("sub account factory data is invalid");
    }
    async function e$() {
    ...
    async function e2(e, { iv: t, cipherText: n }) {
      let a = await crypto.subtle.decrypt({ name: "AES-GCM", iv: t }, e, n);
    ...
    async function e8(e, t) {
      return JSON.parse(await e2(t, e));
    }
    ...
    e9.abytes,
      ...
      e9.utf8ToBytes,
      te.abool,
      te.numberToHexUnpadded,
      te.hexToNumber,
      te.bytesToNumberBE,
      te.bytesToNumberLE,
      te.numberToBytesBE,
      te.numberToBytesLE,
      te.numberToVarBytesBE,
      te.ensureBytes;
    let tt = te.equalBytes;
    te.copyBytes,
      te.asciiToBytes,
      te.inRange,
      te.aInRange,
    ...
    class tn extends Error {
      constructor(e, t = {}) {
        const n = (() => {
          ...
          a = (t.cause instanceof tn && t.cause.docsPath) || t.docsPath,
          r = `https://oxlib.sh${a ?? ""}`;
        super(
          [
            e || "An error occurred.",
            ...
            ...(n || a
              ? ["", n ? `Details: ${n}` : void 0, a ? `See: ${r}` : void 0]
              : []),
          ]
    ...
    function tr(e, t) {
      if (th(e) > t) throw new tv({ givenSize: th(e), maxSize: t });
    }
    function ti(e) {
      return e >= 48 && e <= 57
        ? e - 48
    ...
    function ts(e, t) {
      if (tR(e) > t) throw new tY({ givenSize: tR(e), maxSize: t });
    }
    function to(e, t = {}) {
      ...
      return `0x${r["right" === n ? "padEnd" : "padStart"](2 * a, "0")}`;
    }
    function tc(e, t = {}) {
      let { dir: n = "left" } = t,
        a = e.replace("0x", ""),
      ...
      return "0" === (a = "left" === n ? a.slice(r) : a.slice(0, a.length - r))
        ? "0x"
    ...
    function td(e) {
      return e instanceof Uint8Array ? e : "string" == typeof e ? tp(e) : tf(e);
    }
    function tf(e) {
      ...
      return "number" == typeof n
        ? (tr(a, n),
          (function (e, t = {}) {
            ...
            if (0 === a) return e;
            if (e.length > a)
              throw new tx({ size: e.length, targetSize: a, type: "Bytes" });
    ...
    function tb(e, t, n, a = {}) {
      let { strict: r } = a;
      if ("number" == typeof t && t > 0 && t > th(e) - 1)
        throw new tw({ offset: t, position: "start", size: th(e) });
      let i = e.slice(t, n);
      return (
        r &&
          (function (e, t, n) {
            if ("number" == typeof t && "number" == typeof n && th(e) !== n - t)
              throw new tw({ offset: n, position: "end", size: th(e) });
          })(i, t, n),
        i
      );
    }
    function tg(e, t = {}) {
      let { size: n } = t;
      return void 0 !== n && tr(e, n), tq(tO(e, t), t);
    }
    class ty extends tn {
      constructor(e) {
        super(
          `Value \`${
            "object" == typeof e ? ta(e) : e
    ...
    let tk = new TextEncoder(),
      tA = Array.from({ length: 256 }, (e, t) =>
        t.toString(16).padStart(2, "0")
      );
    function tS(e, t = {}) {
      let { strict: n = !1 } = t;
      if (!e || "string" != typeof e) throw new tJ(e);
    ...
    function tE(e, t = {}) {
      let n = `0x${Number(e)}`;
      return "number" == typeof t.size ? (ts(n, t.size), tN(n, t.size)) : n;
    }
    function tO(e, t = {}) {
      let n = "";
      for (let t = 0; t < e.length; t++) n += tA[e[t]];
      let a = `0x${n}`;
      return "number" == typeof t.size ? (ts(a, t.size), tU(a, t.size)) : a;
    }
    function tC(e, t = {}) {
      let n,
        { signed: a, size: r } = t,
      ...
      let s = "bigint" == typeof n && a ? -n - 1n : 0;
      if ((n && i > n) || i < s) {
      ...
      let o = (a && i < 0 ? (1n << BigInt(8 * r)) + BigInt(i) : i).toString(16),
        c = `0x${o}`;
      return r ? tN(c, r) : c;
    }
    function tP(e, t = {}) {
      return tO(tk.encode(e), t);
    }
    function tj(e, t) {
      return tt(tp(e), tp(t));
    }
    function tN(e, t) {
      return to(e, { dir: "left", size: t });
    }
    function tU(e, t) {
      return to(e, { dir: "right", size: t });
    }
    function tB(e) {
      return tO(crypto.getRandomValues(new Uint8Array(e)));
    }
    function tM(e, t, n, a = {}) {
      let { strict: r } = a;
      if ("number" == typeof t && t > 0 && t > tR(e) - 1)
        throw new tG({ offset: t, position: "start", size: tR(e) });
      let i = `0x${e
        .replace("0x", "")
      ...
      return (
        r &&
          (function (e, t, n) {
            if ("number" == typeof t && "number" == typeof n && tR(e) !== n - t)
              throw new tG({ offset: n, position: "end", size: tR(e) });
          })(i, t, n),
        i
      );
    }
    ...
    function tD(e) {
      return tc(e, { dir: "left" });
    }
    function tK(e) {
      return tc(e, { dir: "right" });
    }
    function tq(e, t = {}) {
      let { signed: n } = t;
      t.size && ts(e, t.size);
    ...
    function tF(e, t = {}) {
      ...
      return n || a ? Number(tq(e, t)) : Number(e);
    }
    function tz(e, t = {}) {
      let { size: n } = t,
        a = tp(e);
    ...
    class tZ extends tn {
      constructor({ max: e, min: t, signed: n, size: a, value: r }) {
        super(
          `Number \`${r}\` is not in safe${a ? ` ${8 * a}-bit` : ""}${
            n ? " signed" : " unsigned"
    ...
    function t0(e, t = {}) {
      ...
      if (!1 === n || ("bigint" == typeof r && "bigint" == typeof i)) {
        if (4 !== a) throw new t9({ prefix: a, cause: new nt() });
        return;
      }
      if (!0 === n || ("bigint" == typeof r && void 0 === i)) {
        if (3 !== a && 2 !== a) throw new t9({ prefix: a, cause: new ne() });
        return;
      }
      throw new t7({ publicKey: e });
    }
    function t1(e) {
      let { x: t, y: n } = e;
    ...
    function t3(e) {
      ...
      if (130 === e.length)
        return { prefix: 4, x: BigInt(tM(e, 0, 32)), y: BigInt(tM(e, 32, 64)) };
      if (132 === e.length) {
        let t = Number(tM(e, 0, 1));
        return { prefix: t, x: BigInt(tM(e, 1, 33)), y: BigInt(tM(e, 33, 65)) };
      }
      return { prefix: Number(tM(e, 0, 1)), x: BigInt(tM(e, 1, 33)) };
    }
    function t5(e, t = {}) {
      return tp(t4(e, t));
    }
    function t4(e, t = {}) {
      ...
      return tI(
        i ? tC(n, { size: 1 }) : "0x",
        tC(a, { size: 32 }),
        "bigint" == typeof r ? tC(r, { size: 32 }) : "0x"
      );
    }
    function t8(e, t = {}) {
      try {
    ...
    class t7 extends tn {
      constructor({ publicKey: e }) {
        super(`Value \`${ta(e)}\` is not a valid public key.`, {
          metaMessages: [
    ...
    function ns(e, t = {}) {
      ...
      if (void 0 === e.r || void 0 === e.s || (n && void 0 === e.yParity))
        throw new nE({ signature: e });
      if (e.r < 0n || e.r > ni) throw new nO({ value: e.r });
      if (e.s < 0n || e.s > ni) throw new nC({ value: e.s });
      if ("number" == typeof e.yParity && 0 !== e.yParity && 1 !== e.yParity)
        throw new nP({ value: e.yParity });
    }
    function no(e) {
      return nc(tO(e));
    }
    function nc(e) {
      if (130 !== e.length && 132 !== e.length) throw new nT({ signature: e });
      let t = BigInt(tM(e, 0, 32)),
        n = BigInt(tM(e, 32, 64)),
        a = (() => {
          ...
          if (!Number.isNaN(t))
            try {
              ...
              throw new nP({ value: t });
            }
        })();
      return void 0 === a ? { r: t, s: n } : { r: t, s: n, yParity: a };
    }
    function nu(e) {
      if (void 0 !== e.r && void 0 !== e.s) return nl(e);
    }
    function nl(e) {
      let t =
        "string" == typeof e
    ...
    function nf(e) {
      let { r: t, s: n } = nr.secp256k1.Signature.fromDER(tT(e).slice(2));
      return { r: t, s: n };
    }
    function np(e) {
      return { r: e.r, s: e.s, yParity: nS(e.v) };
    }
    function nm(e) {
      let t = (() => {
        ...
        if (
          ("number" == typeof t && "number" != typeof n && (n = nS(t)),
          "number" != typeof n)
        )
          throw new nP({ value: e.yParity });
        return n;
    ...
    function ng(e) {
      ...
      return tI(
        tC(t, { size: 32 }),
        tC(n, { size: 32 }),
        "number" == typeof e.yParity ? tC(nI(e.yParity), { size: 1 }) : "0x"
      );
    }
    function ny(e) {
      return new nr.secp256k1.Signature(e.r, e.s).toDERRawBytes();
    }
    function nv(e) {
      let t = new nr.secp256k1.Signature(e.r, e.s);
      return `0x${t.toDERHex()}`;
    }
    function nw(e) {
      return { r: e.r, s: e.s, v: nI(e.yParity) };
    }
    function nx(e) {
    ...
    function nS(e) {
      ...
      throw new nj({ value: e });
    }
    function nI(e) {
      if (0 === e) return 27;
      if (1 === e) return 28;
      throw new nP({ value: e });
    }
    class nT extends tn {
    ...
    function nD(e) {
      ...
      return new Uint8Array(a.buffer, 0, (n >> 2) * 3 + (n % 4 && (n % 4) - 1));
    }
    let nK = BigInt(0x100000000 - 1),
      nq = BigInt(32);
    function nH(e, t = !1) {
      let n = e.length,
        a = new Uint32Array(n),
      ...
      for (let i = 0; i < n; i++) {
        let { h: n, l: s } = (function (e, t = !1) {
          return t
            ? { h: Number(e & nK), l: Number((e >> nq) & nK) }
            : { h: 0 | Number((e >> nq) & nK), l: 0 | Number(e & nK) };
        })(e[i], t);
        [a[i], r[i]] = [n, s];
      }
      return [a, r];
    ...
    let n_ = BigInt(0),
      ...
      n5 = [],
      n4 = [];
    for (let e = 0, t = n$, n = 1, a = 0; e < 24; e++) {
      ([n, a] = [a, (2 * n + 3 * a) % 5]),
        n3.push(2 * (5 * a + n)),
        n5.push((((e + 1) * (e + 2)) / 2) % 64);
      let r = n_;
      for (let e = 0; e < 7; e++)
        (t = ((t << n$) ^ ((t >> n1) * n6)) % n2) & n0 &&
          (r ^= n$ << ((n$ << BigInt(e)) - n$));
    ...
    class an extends nY {
            ...
            for (let a = 24 - t; a < 24; a++) {
              ...
              for (let n = 0; n < 24; n++) {
                let a = n5[n],
                  ...
                  s = at(t, r, a),
                  o = n3[n];
                (t = e[o]), (r = e[o + 1]), (e[o] = i), (e[o + 1] = s);
              }
              for (let t = 0; t < 50; t += 10) {
                for (let a = 0; a < 10; a++) n[a] = e[t + a];
                for (let a = 0; a < 10; a++)
                  e[t + a] ^= ~n[(a + 2) % 10] & n[(a + 4) % 10];
              }
              (e[0] ^= n7[a]), (e[1] ^= n9[a]);
            }
            nZ(n);
      ...
      finish() {
        ...
        this.finished = !0;
        let { state: e, suffix: t, pos: n, blockLen: a } = this;
        (e[n] ^= t),
          (128 & t) != 0 && n === a - 1 && this.keccak(),
          (e[a - 1] ^= 128),
          this.keccak();
      }
      writeInto(e) {
        nz(this, !1), nF(e), this.finish();
        let t = this.state,
          { blockLen: n } = this;
        for (let a = 0, r = e.length; a < r; ) {
          this.posOut >= n && this.keccak();
          let i = Math.min(n - this.posOut, r - a);
      ...
      xof(e) {
        return nL(e), this.xofInto(new Uint8Array(e));
      }
      digestInto(e) {
        if ((nW(e, this), this.finished))
      ...
      destroy() {
        (this.destroyed = !0), nZ(this.state);
      }
      _cloneInto(e) {
        let {
          blockLen: t,
    ...
    class ar extends nY {
      ...
      update(e) {
        ...
        let { view: t, buffer: n, blockLen: a } = this,
          r = e.length;
        for (let i = 0; i < r; ) {
          let s = Math.min(a - this.pos, r - i);
          if (s === a) {
            let t = nV(e);
            for (; a <= r - i; i += a) this.process(t, i);
            continue;
          }
      ...
      digestInto(e) {
        nz(this), nW(e, this), (this.finished = !0);
        let { buffer: t, view: n, blockLen: a, isLE: r } = this,
          { pos: i } = this;
        (t[i++] = 128),
          nZ(this.buffer.subarray(i)),
          this.padOffset > a - i && (this.process(n, 0), (i = 0));
        ...
        !(function (e, t, n, a) {
          ...
          let r = BigInt(32),
            ...
            c = 4 * !!a,
            u = 4 * !a;
          e.setUint32(t + c, s, a), e.setUint32(t + u, o, a);
        })(n, a - 8, BigInt(8 * this.length), r),
          this.process(n, 0);
        let s = nV(e),
          o = this.outputLen;
        ...
        for (let e = 0; e < c; e++) s.setUint32(4 * e, u[e], r);
      }
      digest() {
    ...
    class ad extends ar {
      ...
      get() {
        let { A: e, B: t, C: n, D: a, E: r, F: i, G: s, H: o } = this;
        return [e, t, n, a, r, i, s, o];
      }
      set(e, t, n, a, r, i, s, o) {
        (this.A = 0 | e),
          (this.B = 0 | t),
      ...
      process(e, t) {
        for (let n = 0; n < 16; n++, t += 4) al[n] = e.getUint32(t, !1);
        for (let e = 16; e < 64; e++) {
          let t = al[e - 15],
            n = al[e - 2],
            a = nJ(t, 7) ^ nJ(t, 18) ^ (t >>> 3),
            r = nJ(n, 17) ^ nJ(n, 19) ^ (n >>> 10);
          al[e] = (r + al[e - 7] + a + al[e - 16]) | 0;
        }
        let { A: n, B: a, C: r, D: i, E: s, F: o, G: c, H: u } = this;
        for (let e = 0; e < 64; e++) {
          var l, d, f, p;
          let t =
              (u +
                (nJ(s, 6) ^ nJ(s, 11) ^ nJ(s, 25)) +
                (((l = s) & o) ^ (~l & c)) +
                au[e] +
                al[e]) |
              0,
            m =
              ((nJ(n, 2) ^ nJ(n, 13) ^ nJ(n, 22)) +
                (((d = n) & (f = a)) ^ (d & (p = r)) ^ (f & p))) |
              0;
          (u = c),
            (c = o),
    ...
    let aS = {
      ...
      aO = (0, ak.Field)(aI.p),
      aC = (0, ak.Field)(aT.p),
      aP = (0, aw.createCurve)({ ...aS, Fp: aE, lowS: !1 }, av.sha256);
    async function aj(e) {
      try {
    ...
    (0, ax.createHasher)(
      aP.Point,
      ((u = aP.Point),
      (l = { A: aS.a, B: aS.b, Z: aP.Point.Fp.create(BigInt("-10")) }),
      (r = (0, aA.mapToCurveSimpleSWU)(u.Fp, l)),
      (e) => r(e[0])),
      {
      ...
      (0, aw.createCurve)({ ...aI, Fp: aO, lowS: !1 }, av.sha384),
      (0, aw.createCurve)(
        { ...aT, Fp: aC, lowS: !1, allowedPrivateKeyLengths: [130, 131, 132] },
        av.sha512
      );
    let aN = Uint8Array.from([
    ...
    function aB(e = {}) {
      ...
      return tI(ay(tP(n)), tC(t, { size: 1 }), tC(a, { size: 4 }));
    }
    function aM(e) {
      let {
        challenge: t,
        ...
        challenge: (function (e, t = {}) {
          return (function (e, t = {}) {
            ...
            let i = e.length % 3,
              ...
              o = nB.decode(new Uint8Array(r.buffer, 0, s));
            return (
              n && 1 === i && (o += "=="),
              n && 2 === i && (o += "="),
              a && (o = o.replaceAll("+", "-").replaceAll("/", "_")),
              o
            );
          })(tp(e), t);
        })(t, { url: !0, pad: !1 }),
    ...
    function aD(e) {
      ...
      return {
        publicKey: {
          ...(t
            ? { allowCredentials: [{ id: nD(t), type: "public-key" }] }
            : {}),
          challenge: tp(n),
          rpId: a,
          userVerification: r,
    ...
    function aK(e) {
      let {
        ...
        u = aB({ flag: r, rpId: s, signCount: o }),
        l = aM({ challenge: t, crossOrigin: n, extraClientData: a, origin: i }),
        d = ay(tP(l)),
    ...
    async function aq(e) {
      ...
      try {
        ...
        let u = c.response,
          ...
          f = l.indexOf('"type"'),
          p =
            ((r = new Uint8Array(u.signature)),
            (n = (e = 0 === r[4] ? 5 : 4) + 32),
            (i = 0 === r[n + 2] ? n + 3 : n + 2),
            (s = BigInt(tO(r.slice(e, n)))),
            (o = BigInt(tO(r.slice(i)))),
            { r: s, s: o > aP.CURVE.n / 2n ? aP.CURVE.n - o : o });
        return {
          metadata: {
            authenticatorData: tO(new Uint8Array(u.authenticatorData)),
            clientDataJSON: l,
            challengeIndex: d,
            typeIndex: f,
    ...
    function aH(e) {
      ...
      return (
        tO(nD(b)) === t &&
        (function (e) {
          let { hash: t, payload: n, publicKey: a, signature: r } = e;
          return aP.verify(
            r,
            n instanceof Uint8Array ? n : tp(n),
            t4(a).substring(2),
            ...(t ? [{ prehash: !0, lowS: !0 }] : [])
          );
        })({
          hash: n,
          payload: tl(d, ay(tm(c), { as: "Bytes" })),
          publicKey: r,
          signature: i,
        })
      );
    ...
    async function aZ(e) {
      let { payload: t, privateKey: n } = e,
        ...
        r = tg(tb(a, 0, 32)),
        i = tg(tb(a, 32, 64));
      return i > aP.CURVE.n / 2n && (i = aP.CURVE.n - i), { r, s: i };
    }
    async function aV(e) {
      ...
      return await globalThis.crypto.subtle.verify(
        { name: "ECDSA", hash: "SHA-256" },
        a,
        tl(tp(tC(n.r, void 0)), tp(tC(n.s, void 0))),
        td(t)
      );
    }
    e.s(
      ["createKeyPair", () => aW, "sign", () => aZ, "verify", () => aV],
      750246
    );
    var aJ = e.i(750246),
      aJ = aJ,
    ...
    let aG = "activeId",
      a_ =
        ((i =
          "u" > typeof indexedDB
            ? (0, aY.createStore)("base-acc-sdk", "keys")
            : void 0),
        {
          getItem: async (e) => {
            let t = await (0, aY.get)(e, i);
            return t || null;
          },
          removeItem: async (e) => (0, aY.del)(e, i),
          setItem: async (e, t) => (0, aY.set)(e, t, i),
        });
    async function a$() {
      let e = await aJ.createKeyPair({ extractable: !1 }),
        t = t$.slice(na.toHex(e.publicKey), 1);
      return await a_.setItem(t, e), await a_.setItem(aG, t), e;
    }
    async function a0() {
      let e = await a_.getItem(aG);
      if (!e) return null;
      let t = await a_.getItem(e);
      return t || null;
    }
    async function a1() {
      let e = await a0();
    ...
    async function a2() {
      let e = await a1(),
        t = t$.slice(na.toHex(e.publicKey), 1),
        n = async (t) => {
          let { payload: n, metadata: a } = az.getSignPayload({
              challenge: t,
              origin: "https://keys.coinbase.com",
              userVerification: "preferred",
            }),
            r = await aJ.sign({ payload: n, privateKey: e.privateKey });
          return { signature: nN.toHex(r), raw: {}, webauthn: a };
        };
      return {
        id: t,
        publicKey: t,
        sign: async ({ hash: e }) => n(e),
        signMessage: async ({ message: e }) => n((0, aQ.hashMessage)(e)),
        signTypedData: async (e) => n((0, aX.hashTypedData)(e)),
        type: "webAuthn",
      };
    }
    async function a6() {
      return { account: await a2() };
    }
    async function a3() {
      let e = await a0();
      e &&
        (await a_.removeItem(t$.slice(na.toHex(e.publicKey), 1)),
        await a_.removeItem(aG));
    }
    let a5 = { storageKey: "ownPrivateKey", keyType: "private" },
      a4 = { storageKey: "ownPublicKey", keyType: "public" },
      a8 = { storageKey: "peerPublicKey", keyType: "public" };
    class a7 {
      constructor() {
      ...
      async generateKeyPair() {
        ...
        (this.ownPrivateKey = e.privateKey),
          ...
          await this.storeKey(a5, e.privateKey),
          await this.storeKey(a4, e.publicKey);
      }
      async loadKeysIfNeeded() {
        null === this.ownPrivateKey &&
          (this.ownPrivateKey = await this.loadKey(a5)),
          null === this.ownPublicKey &&
            (this.ownPublicKey = await this.loadKey(a4)),
          (null === this.ownPrivateKey || null === this.ownPublicKey) &&
            (await this.generateKeyPair()),
          null === this.peerPublicKey &&
            (this.peerPublicKey = await this.loadKey(a8)),
          null === this.sharedSecret &&
            null !== this.ownPrivateKey &&
            null !== this.peerPublicKey &&
            (this.sharedSecret = await e0(
              this.ownPrivateKey,
              this.peerPublicKey
            ));
      }
      async loadKey(e) {
        let t = S.keys.get(e.storageKey);
        return t ? e5(e.keyType, t) : null;
      }
      async storeKey(e, t) {
        let n = await e3(e.keyType, t);
        S.keys.set(e.storageKey, n);
      }
    }
    var a9 = e.i(831095),
      re = e.i(790063);
    ...
    function ri(e, t) {
      ...
      if (t && e.method.startsWith("wallet_")) {
        let e = rt(n, "params.0.capabilities");
        if ((void 0 === e && (e = {}), "object" != typeof e)) throw L();
    ...
    async function ro({ client: e, id: t }) {
      var n;
      let a = await (0, rn.waitForCallsStatus)(e, { id: t });
      if ("success" === a.status)
        return null == (n = a.receipts) ? void 0 : n[0].transactionHash;
      throw F("failed to send transaction");
    }
    function rc({ calls: e, from: t, chainId: n, capabilities: a }) {
      let r = A.get().paymasterUrls,
        i = {
      ...
      return (
        (null == r ? void 0 : r[n]) &&
          (i = ri(i, { paymasterService: { url: null == r ? void 0 : r[n] } })),
        i
      );
    }
    async function ru() {
      ...
      return await new Promise((t) => {
        ed({ dialogContext: "sub_account_insufficient_balance" }),
          e.presentItem({
            ...
            onClose: () => {
              ef({ dialogContext: "sub_account_insufficient_balance" }),
                e.clear();
            },
            actionItems: [
              {
    ...
    async function rE(e) {
      let {
        ...
        s = {
          abi: rk.entryPoint06Abi,
          address: rA.entryPoint06Address,
          version: "0.6",
        },
        o = { abi: E, address: "0xba5ed110efdba3d005bfc882d75358acbbb85842" };
      return (0, rI.toSmartAccount)({
        client: r,
        entryPoint: s,
        extend: { abi: T, factory: o },
        async decodeCalls(e) {
          let t = (0, rg.decodeFunctionData)({ abi: T, data: e });
        ...
        async sign(e) {
          ...
          return rP({
            ownerIndex: n,
            signature: await rO({ hash: a, owner: t }),
          });
        },
        async signMessage(e) {
          let { message: a } = e,
            i = rC({
              address: await this.getAddress(),
              chainId: r.chain.id,
              hash: (0, aQ.hashMessage)(a),
            });
          return rP({
            ownerIndex: n,
            signature: await rO({ hash: i, owner: t }),
          });
        },
        async signTypedData(e) {
          let { domain: a, types: i, primaryType: s, message: o } = e,
            c = rC({
              address: await this.getAddress(),
              chainId: r.chain.id,
              hash: (0, aX.hashTypedData)({
                domain: a,
                message: o,
                primaryType: s,
                types: i,
          ...
          return rP({
            ownerIndex: n,
            signature: await rO({ hash: c, owner: t }),
          });
        },
        async signUserOperation(e) {
          let { chainId: a = r.chain.id } = e,
            i = rT(e, ["chainId"]),
            o = await this.getAddress(),
            c = (0, rS.getUserOperationHash)({
              chainId: a,
    ...
    async function rO({ hash: e, owner: t }) {
      if ("webAuthn" === t.type) {
        let { signature: n, webauthn: a } = await t.sign({ hash: e });
        return (function ({ webauthn: e, signature: t }) {
          let { r: n, s: a } = nc(t);
          return (0, ry.encodeAbiParameters)(
            [
              {
                components: [
            ...
            [
              {
                ...
                clientDataJSON: (0, eu.stringToHex)(e.clientDataJSON),
        ...
        })({ signature: n, webauthn: a });
      }
      if (t.sign) return t.sign({ hash: e });
      throw new rb.BaseError("`owner` does not support raw sign.");
    }
    function rC({ address: e, chainId: t, hash: n }) {
      return (0, aX.hashTypedData)({
        domain: {
          chainId: t,
    ...
    function rP(e) {
      let { ownerIndex: t = 0 } = e,
        n = (() => {
          if (65 !== (0, rx.size)(e.signature)) return e.signature;
          let t = (0, rw.parseSignature)(e.signature);
          return (0, rv.encodePacked)(
    ...
    async function rj({
      ...
      var c;
      let u = { address: e, factory: n, factoryData: a },
        l = null == (c = t.chain) ? void 0 : c.id;
      if (!l) throw F("chainId not found");
      let d = await rE({
          owner: r,
          ...
          try {
            switch (e.method) {
              ...
              case "net_version":
                return l.toString();
              case "eth_chainId":
                return (0, eu.numberToHex)(l);
              case "eth_sendTransaction": {
                en(e.params);
                let r = e.params[0];
                et(r.to, L("to is required"));
                let s = {
                    to: r.to,
                    data: eD(null != (n = r.data) ? n : "0x", !0),
                    value: eD(null != (a = r.value) ? a : "0x", !0),
                    from: null != (i = r.from) ? i : u.address,
                  },
                  o = rc({ calls: [s], chainId: l, from: s.from }),
                  c = await f(o);
                return ro({ client: t, id: c });
              }
              case "wallet_sendCalls": {
                let t;
                en(e.params);
                let n = rt(e.params[0], "chainId");
                if (!n) throw L("chainId is required");
                if (!(0, eG.isHex)(n))
                  throw L("chainId must be a hex encoded integer");
                if (!e.params[0]) throw L("params are required");
                if (!("calls" in e.params[0])) throw L("calls are required");
                let a = {
                ...
                let i = await f(a),
                  o = await (null == (c = r.sign)
                    ? void 0
                    : c.call(r, {
                        hash: (0, eK.hexToString)(i.signatureRequest.hash),
                      }));
                if (!o) throw F("signature not found");
                return (
                  (t = (0, eG.isHex)(o)
                    ? {
                        type: "secp256k1",
                        data: { address: r.address, signature: o },
                      }
                    : {
                        type: "webauthn",
                        data: {
                          signature: JSON.stringify(
                            (function ({ webauthn: e, signature: t, id: n }) {
                              ...
                              return {
                                id: n,
                                rawId: rh((0, rp.stringToBytes)(n)),
                                response: {
                                  authenticatorData: rh(
                                    (0, rp.hexToBytes)(e.authenticatorData)
                                  ),
                                  clientDataJSON: rh(
                                    (0, rp.stringToBytes)(e.clientDataJSON)
                                  ),
                                  signature: rh(
                                    ((a = d.r),
                                    (r = d.s),
                                    (i = (0, rp.hexToBytes)(
                                      (0, rm.trim)((0, eu.numberToHex)(a))
                                    )),
                                    (s = (0, rp.hexToBytes)(
                                      (0, rm.trim)((0, eu.numberToHex)(r))
                                    )),
                                    (o = i.length),
                                    (c = s.length),
                                    (u = o + c + 4),
              ...
              case "wallet_prepareCalls": {
                ...
                if (!(0, eG.isHex)(n))
                  throw L("chainId must be a hex encoded integer");
                if (!e.params[0]) throw L("params are required");
                if (!rt(e.params[0], "calls")) throw L("calls are required");
                let a = e.params[0];
                return (
                  !o ||
                    !a.capabilities ||
              ...
              case "personal_sign": {
                if ((en(e.params), !(0, eG.isHex)(e.params[0])))
                  throw L("message must be a hex encoded string");
                let t = (0, eK.hexToString)(e.params[0]);
    ...
    async function rM({
      ...
      if (!(await (0, rU.getCode)(t, { address: e })) && a && r) {
        let e = (0, rg.decodeFunctionData)({ abi: E, data: r });
        if ("createAccount" !== e.functionName)
          throw F("unknown factory function");
        let [t] = e.args;
        return t.findIndex((e) => e.toLowerCase() === rR(n).toLowerCase());
      }
      let i = await (0, rB.readContract)(t, {
        address: e,
        abi: T,
        functionName: "ownerCount",
      });
      for (let a = Number(i) - 1; a >= 0; a--) {
        let r = await (0, rB.readContract)(t, {
            address: e,
            abi: T,
          ...
          i = rR(n);
        if (r.toLowerCase() === i.toLowerCase()) return a;
      }
      return -1;
    }
    function rR(e) {
      return (0, eY.isAddress)(e) ? (0, rN.pad)(e) : e;
    }
    async function rD() {
      var e, t;
      let n =
          null !=
          (t = null == (e = S.config.get().metadata) ? void 0 : e.appName)
            ? t
            : "App",
        a = eO();
      return new Promise((e) => {
        ed({ dialogContext: "sub_account_add_owner" }),
          a.presentItem({
            title: `Re-authorize ${n}`,
            message: `${n} has lost access to your account. Please sign at the next step to re-authorize ${n}`,
            onClose: () => {
              ef({ dialogContext: "sub_account_add_owner" }), e("cancel");
            },
            actionItems: [
              {
                text: "Continue",
    ...
    async function rK({ ownerAccount: e, globalAccountRequest: t }) {
      var n, a;
      let r = S.account.get(),
        i = S.subAccounts.get(),
        s =
      ...
      et(s, Z("no global account")),
        et(null == (a = r.chain) ? void 0 : a.id, Z("no chain id")),
        et(null == i ? void 0 : i.address, Z("no sub account"));
      let o = [];
      if (
        ("local" === e.type &&
          e.address &&
        ...
        let [t, n] = (0, eo.decodeAbiParameters)(
        ...
        params: [
          {
            version: "1",
            calls: o,
            chainId: (0, eu.numberToHex)(84532),
            from: s,
          },
        ],
      };
      if ("cancel" === (await rD())) throw Z("user cancelled");
      let u = await t(c),
        l = eJ(r.chain.id);
      if (
        (et(l, F(`client not found for chainId ${r.chain.id}`)),
        "success" !== (await (0, rn.waitForCallsStatus)(l, { id: u })).status)
      )
        throw F("add owner call failed");
      let d = await rM({
        address: i.address,
        publicKey: "local" === e.type && e.address ? e.address : e.publicKey,
        client: l,
      });
      if (-1 === d) throw F("failed to find owner index");
      return d;
    }
    var rq = e.i(752012);
    async function rH({
      ...
      let l,
        d,
        f = null == (o = a.chain) ? void 0 : o.id;
      et(f, F("invalid chainId"));
      let p = (function ({ errorData: e, sourceAddress: t }) {
          var n;
          let a = [];
          for (let [r, { amount: i, sources: s }] of Object.entries(
            ...
            if (
              ...
              s.filter(
                (e) =>
                  (0, eK.hexToBigInt)(e.balance) >= (0, eK.hexToBigInt)(i) &&
            ...
            a.push({ token: r, requiredAmount: (0, eK.hexToBigInt)(i) });
          }
          return a;
      ...
      if ("update_permission" === m) {
        if (1 === p.length) {
          let e = p[0],
            a = (function ({ spendPermission: e, chainId: t }) {
              return {
                domain: {
              ...
              spendPermission: {
                token: e.token,
                allowance: (0, eu.numberToHex)(e.requiredAmount * BigInt(3)),
                period: 86400,
                account: t,
                spender: n,
                start: 0,
                end: 0xffffffffffff,
                salt: (0, eu.numberToHex)(
          ...
          l = { method: "eth_signTypedData_v4", params: [t, a] };
        } else {
      ...
      let h = p.map((e) =>
        "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee" === e.token.toLowerCase()
          ? { to: n, value: (0, eu.numberToHex)(e.requiredAmount), data: "0x" }
          : {
              to: e.token,
              value: "0x0",
              data: (0, ec.encodeFunctionData)({
      ...
      if (
        "wallet_sendCalls" === r.method &&
        "object" == typeof (c = r.params) &&
        null !== c &&
        "calls" in c
      )
        d = r.params[0];
      else if (
        "eth_sendTransaction" === r.method &&
        Array.isArray((u = r.params)) &&
        1 === u.length &&
        "object" == typeof u[0] &&
        null !== u[0] &&
        "to" in u[0]
      )
        d = rc({ calls: [r.params[0]], chainId: f, from: r.params[0].from })
          .params[0];
      ...
      let b = [
        ...
        g = await s({
          method: "wallet_sendCalls",
          params: [Object.assign(Object.assign({}, d), { calls: b, from: t })],
        });
      return "eth_sendTransaction" === r.method ? ro({ client: a, id: g }) : g;
    }
    class rL {
      constructor(e) {
        var t, n, a, r;
        (this.communicator = e.communicator),
          ...
          (this.keyManager = new a7());
        const { account: i, chains: s } = S.getState();
          ...
          (this.chain =
            null != (n = i.chain)
              ...
              : {
                  id:
                    null !=
                    (r = null == (a = e.metadata.appChainIds) ? void 0 : a[0])
                      ? r
                      : 1,
                }),
          s && eV(s);
      ...
      async handshake(e) {
          ...
          el(
            "scw_signer.handshake.started",
            {
              ...
              enableAutoSubAccounts:
                null == (n = S.subAccountsConfig.get())
                  ? void 0
        ...
        try {
          ...
          let o = await e5("public", s.sender);
            ...
            ((({ method: e, correlationId: t, errorMessage: n }) => {
              ...
              el(
                "scw_signer.handshake.error",
                {
                  ...
                  errorMessage: n,
                  enableAutoSubAccounts:
                    null == (a = S.subAccountsConfig.get())
                      ? void 0
                      : a.enableAutoSubAccounts,
                },
                p.high
              );
            })({ method: e.method, correlationId: r, errorMessage: eH(t) }),
            t)
          );
        }
      }
      async request(e) {
        ...
        try {
          ...
          throw (
            ...
            })({ method: e.method, correlationId: t, errorMessage: eH(n) }),
            n)
          );
        }
      }
      async _request(e) {
        var t, n, a, r, i, s, o, c, u, l;
        if (0 === this.accounts.length)
          switch (e.method) {
            case "wallet_switchEthereumChain":
              rr(e.params), (this.chain.id = Number(e.params[0].chainId));
              return;
            case "wallet_connect": {
              await (null == (n = (t = this.communicator).waitForPopupLoaded)
                ? void 0
              ...
              (function (e, t) {
                ...
                let a = null == (n = e.params[0]) ? void 0 : n.capabilities;
                return !!a && "object" == typeof a && t in a;
              })(e, "addSubAccount") &&
                (i =
                  null !=
                  (r =
        ...
        switch (e.method) {
          ...
          case "eth_accounts": {
            let e = S.subAccounts.get(),
              t = S.subAccountsConfig.get();
            return (
              (null == e ? void 0 : e.address) &&
                (this.accounts = (null == t ? void 0 : t.enableAutoSubAccounts)
                  ? rl(this.accounts, e.address)
                  : rd(this.accounts, e.address)),
              null == (i = this.callback) ||
                i.call(this, "connect", {
                  chainId: (0, eu.numberToHex)(this.chain.id),
                }),
              this.accounts
            );
          }
          ...
          case "eth_chainId":
            return (0, eu.numberToHex)(this.chain.id);
          ...
          case "wallet_connect": {
            ...
            await (null == (o = (s = this.communicator).waitForPopupLoaded)
              ...
              : o.call(s)),
              await rs();
            let n = S.subAccountsConfig.get(),
              a = ri(
                e,
                null != (c = null == n ? void 0 : n.capabilities) ? c : {}
              ),
              r = await this.sendRequestToPopup(a);
            return (
          ...
          case "wallet_getSubAccounts": {
            let t = S.subAccounts.get();
            if (null == t ? void 0 : t.address) return { subAccounts: [t] };
            if (!this.chain.rpcUrl) throw F("No RPC URL set for chain");
            let n = await e7(e, this.chain.rpcUrl);
            if ((en(n.subAccounts, "subAccounts"), n.subAccounts.length > 0)) {
              e_(n.subAccounts[0]);
          ...
          case "coinbase_fetchPermissions": {
            ...
            let t = (function (e) {
                ...
                let r =
                    null == (t = S.getState().account.accounts) ? void 0 : t[0],
                  i = null == (n = S.getState().account.chain) ? void 0 : n.id,
                  s =
                    null == (a = S.getState().subAccount) ? void 0 : a.address;
                if (!r || !s || !i)
                  throw L(
                ...
                return {
                  ...
                  params: [
                    { account: r, chainId: (0, eu.numberToHex)(i), spender: s },
                  ],
                };
              })(e),
              n = await e7(t, h),
            ...
            return (
              S.spendPermissions.set(
                n.permissions.map((e) =>
                  Object.assign(Object.assign({}, e), { chainId: a })
                )
              ),
              n
            );
      ...
      async sendRequestToPopup(e) {
        ...
        await (null == (n = (t = this.communicator).waitForPopupLoaded)
          ? void 0
          : n.call(t));
        let a = await this.sendEncryptedRequest(e),
          r = await this.decryptResponseMessage(a);
        return this.handleResponse(e, r);
      }
      async handleResponse(e, t) {
        ...
        switch (e.method) {
          case "eth_requestAccounts": {
            let e = o.value;
            (this.accounts = e),
              S.account.set({ accounts: e, chain: this.chain }),
          ...
          case "wallet_connect": {
            ...
            (this.accounts = t), S.account.set({ accounts: t });
            ...
            let c = [this.accounts[0]],
              u = S.subAccounts.get(),
              l = S.subAccountsConfig.get();
            (null == u ? void 0 : u.address) &&
              (this.accounts = (null == l ? void 0 : l.enableAutoSubAccounts)
                ? rl(this.accounts, u.address)
                : rd(this.accounts, u.address));
            let d =
              null ==
              (r =
                null == (a = null == e ? void 0 : e.accounts)
                  ? void 0
                  : a[0].capabilities)
                ? void 0
                : r.spendPermissions;
            d &&
              "permissions" in d &&
              S.spendPermissions.set(null == d ? void 0 : d.permissions),
      ...
      async handleSwitchChainRequest(e) {
        ...
        let t = (function (e) {
          ...
          if ("string" == typeof e) {
            if (eU.test(e)) return eN(Number(e));
            if (
              (function (e) {
                if ("string" != typeof e) return !1;
                let t = eR(e).toLowerCase();
                return eB.test(t);
              })(e)
            )
              return eN(
          ...
          throw L(`Not an integer: ${String(e)}`);
        })(e.params[0].chainId);
      ...
      async handleGetCapabilitiesRequest(e) {
        ...
        if (
          ...
          throw L();
        if (2 === t.length) {
          if (!Array.isArray(t[1])) throw L();
          for (let e of t[1])
            if ("string" != typeof e || !e.startsWith("0x")) throw L();
        }
        let n = e.params[0],
          a = e.params[1];
        if (!this.accounts.some((e) => (0, eq.isAddressEqual)(e, n)))
          throw Z("no active account found when getting capabilities");
        let r = S.getState().account.capabilities;
        if (!r) return {};
        if (!a || 0 === a.length) return r;
        let i = new Set(a.map((e) => (0, eK.hexToNumber)(e)));
        return Object.fromEntries(
          Object.entries(r).filter(([e]) => {
            try {
              let t = (0, eK.hexToNumber)(e);
              return i.has(t);
            } catch (e) {
              return !1;
            }
      ...
      async sendEncryptedRequest(e) {
        ...
        if (!t) throw Z("No shared secret found when encrypting request");
        let n = await e4({ action: e, chainId: this.chain.id }, t),
          a = eX(e),
          r = await this.createRequestMessage({ encrypted: n }, a);
        return this.communicator.postRequestAndWaitForResponse(r);
      }
      async createRequestMessage(e, t) {
        let n = await e3("public", await this.keyManager.getOwnPublicKey());
        return {
          id: crypto.randomUUID(),
          correlationId: t,
          sender: n,
      ...
      async decryptResponseMessage(e) {
        ...
        let s = await e8(r.encrypted, i),
          o = null == (t = s.data) ? void 0 : t.chains;
        if (o) {
          let e = null == (n = s.data) ? void 0 : n.nativeCurrencies,
            t = Object.entries(o).map(([t, n]) => {
              let a = null == e ? void 0 : e[Number(t)];
              return Object.assign(
                { id: Number(t), rpcUrl: n },
                a ? { nativeCurrency: a } : {}
              );
            });
          S.chains.set(t), this.updateChain(this.chain.id, t), eV(t);
        }
        let c = null == (a = s.data) ? void 0 : a.capabilities;
        return c && S.account.set({ capabilities: c }), s;
      }
      updateChain(e, t) {
        var n;
        let a = S.getState(),
        ...
        return (
          ...
          (i !== this.chain &&
            ((this.chain = i),
            S.account.set({ chain: i }),
            null == (n = this.callback) ||
              n.call(this, "chainChanged", eM(i.id))),
          !0)
        );
      }
      async addSubAccount(e) {
        var t, n, a, r;
        let i = S.getState().subAccount,
          s = S.subAccountsConfig.get();
        if (null == i ? void 0 : i.address)
          return (
            (this.accounts = (null == s ? void 0 : s.enableAutoSubAccounts)
              ? rl(this.accounts, i.address)
              : rd(this.accounts, i.address)),
            null == (t = this.callback) ||
              t.call(this, "accountsChanged", this.accounts),
            i
          );
        if (
          (await (null == (a = (n = this.communicator).waitForPopupLoaded)
            ? void 0
            : a.call(n)),
          Array.isArray(e.params) &&
            e.params.length > 0 &&
          ...
          if (e.params[0].account.keys && e.params[0].account.keys.length > 0)
            ...
            let e = null != (r = S.subAccountsConfig.get()) ? r : {},
      ...
      async sendRequestToSubAccountSigner(e) {
        var t;
        let n = S.subAccounts.get(),
          a = S.subAccountsConfig.get(),
          r = S.config.get();
        et(
          null == n ? void 0 : n.address,
          Z("no active sub account when sending request to sub account signer")
        );
        let i = (null == a ? void 0 : a.toOwnerAccount)
          ? await a.toOwnerAccount()
          : await a6();
        et(
          ...
          void 0 === ra(e) &&
            (e = (function (e, t) {
              if (!Array.isArray(e.params)) throw L();
              let n = [...e.params];
              switch (e.method) {
                case "eth_signTransaction":
                case "eth_sendTransaction":
        ...
        let c = (function ({ attribution: e, dappOrigin: t }) {
            ...
            attribution: null == (t = r.preference) ? void 0 : t.attribution,
        ...
        try {
          ...
          let t;
          if (ee(r)) t = JSON.parse(r.details);
          else if ($(r)) t = r;
          else throw r;
          if (!($(t) && t.data) || !t.data) throw r;
          let a = eX(e);
          (({ method: e, correlationId: t }) => {
            var n;
            el(
          ...
          try {
            ...
            throw (
              ...
              })({ method: e.method, correlationId: a, errorMessage: eH(t) }),
              r)
            );
          }
        }
    ...
    class rz extends ej {
      constructor(e) {
        ...
        super(),
          ...
          (this.communicator = new eC({ url: a, metadata: t, preference: r })),
          (this.signer = new rL({
            metadata: t,
      ...
      async request(e) {
        ...
        (t = e),
          (n = r),
          eQ.setState((e) => {
            let a = new Map(e.correlationIds);
            return a.set(t, n), { correlationIds: a };
          }),
          (({ method: e, correlationId: t }) => {
            el(
        ...
        try {
          ...
          (a = e),
            eQ.setState((e) => {
              ...
              return t.delete(a), { correlationIds: t };
            });
        }
      }
      async _request(e) {
          ...
          if (
            ...
            switch (e.method) {
                    ...
                    params: [
                      {
                        ...
                        capabilities: Object.assign(
                          ...
                          null !=
                            (n =
                              null == (t = S.subAccountsConfig.get())
                                ? void 0
                                : t.capabilities)
                            ? n
                            : {}
              ...
              case "eth_chainId":
                return eM(1);
              default:
                throw Z("Must call 'eth_requestAccounts' before other methods");
            }
            ...
            Promise.reject(
              ((e = (function (e, { shouldIncludeStack: t = !1 } = {}) {
                ...
                if (
                  ...
                  (M[n.toString()] || ((a = n) >= -32099 && a <= -32e3))
                )
                  (r.code = e.code),
                    e.message && "string" == typeof e.message
                      ? ((r.message = e.message),
                        q(e, "data") && (r.data = e.data))
                      : ((r.message = D(r.code)),
                        (r.data = { originalError: K(e) }));
                else
                  (r.code = P),
                    (r.message = H(e, "message") ? e.message : R),
                    (r.data = { originalError: K(e) });
                return t && (r.stack = H(e, "stack") ? e.stack : void 0), r;
              })(
                (function (e) {
                  var t;
                  if ("string" == typeof e) return { message: e, code: P };
      ...
      async disconnect() {
        await this.signer.cleanup(),
          eQ.setState({ correlationIds: new Map() }),
          this.emit("disconnect", J("User initiated disconnection"));
      }
    }
    function rW(e) {
      let t = {
      ...
      (null == (a = e.subAccounts) ? void 0 : a.toOwnerAccount) &&
        es(e.subAccounts.toOwnerAccount),
        ...
        c = {
          ...
          subAccount: {
            ...
            addOwner: async ({ address: e, publicKey: t, chainId: n }) => {
              var a, r;
              let i = S.subAccounts.get(),
                s = S.account.get();
              et(s, Error("account does not exist")),
                et(
              ...
              let o = [];
              if (t) {
                let [e, n] = (0, eo.decodeAbiParameters)(
                  [{ type: "bytes32" }, { type: "bytes32" }],
                  t
                );
                o.push({
                ...
                await (null == (a = c.getProvider())
                  ...
                  : a.request({
                      ...
                      params: [
                        {
                          calls: o,
                          chainId: (0, eu.toHex)(n),
                          from: null == (r = s.accounts) ? void 0 : r[0],
                          version: "1",
                        },
                      ],
                    }))
            ...
            setToOwnerAccount(e) {
              es(e), S.subAccountsConfig.set({ toOwnerAccount: e });
            },
          },
        };
      return c;
    ...
    let rZ = {
      ...
      rV = { base: 8453, baseSepolia: 84532 },
      rJ = [
        {
          name: "transfer",
          type: "function",
    ...
    var rQ = e.i(222427),
      rX = e.i(644616);
    let rY = ({ testnet: e, status: t, correlationId: n }) => {
        el(
      ...
      rG = ({ testnet: e, correlationId: t, errorMessage: n }) => {
        el(
    ...
    async function r_(e) {
      var t;
      let { id: n, testnet: a = !1, telemetry: r = !0 } = e,
        i = crypto.randomUUID();
      r &&
      ...
      try {
        ...
        if (s.error) {
          ...
          return (
            r && rG({ testnet: a, correlationId: i, errorMessage: e }),
            {
              status: "failed",
              id: n,
              message:
        ...
        if (!s.result) {
          ...
          if (t.result)
            return (
              r && rY({ testnet: a, status: "pending", correlationId: i }),
              {
                status: "pending",
                id: n,
                message:
          ...
          return (
            r && rY({ testnet: a, status: "not_found", correlationId: i }),
            {
              status: "not_found",
              id: n,
        ...
        if (o) {
          ...
          if (null == c ? void 0 : c.logs) {
            let n = a ? "baseSepolia" : "base",
              r = rZ.USDC.addresses[n].toLowerCase();
            for (let n of c.logs)
              if ((null == (t = n.address) ? void 0 : t.toLowerCase()) === r)
                try {
                  let t = (0, rQ.decodeEventLog)({
                    abi: rJ,
                    data: n.data,
                    topics: n.topics,
                  });
                  if ("Transfer" === t.eventName && t.args) {
                    let n = t.args;
                    if (n.value && n.to) {
                      (e = (0, rX.formatUnits)(n.value, 6)), (o = n.to);
                      break;
                    }
                  }
                } catch (e) {
          ...
          return (
            r && rY({ testnet: a, status: "completed", correlationId: i }),
            {
              status: "completed",
              id: n,
          ...
          return (
            u &&
              (e = u.toLowerCase().includes("insufficient")
                ...
                : u),
            r && rY({ testnet: a, status: "failed", correlationId: i }),
            {
              status: "failed",
              id: n,
    ...
    async function r$(e, t) {
      ...
      return { transactionHash: a, payerInfoResponses: r };
    }
    async function r0(e, t, n, a = !0) {
      let r = (function (e, t, n = !0) {
          return rW({
            appName:
              "u" > typeof window ? window.location.origin : "Base Pay SDK",
            appChainIds: [e],
            preference: { telemetry: n, walletUrl: t },
          });
        })(rV[t ? "baseSepolia" : "base"], n, a),
        i = r.getProvider();
      try {
        return await r$(r, e);
      } finally {
    ...
    async function r2(e) {
      ...
      c &&
        ...
        })({ amount: a, testnet: i, correlationId: u });
      try {
        let e, t, l, m, h;
        if ("string" != typeof a)
          throw Error("Invalid amount: must be a string");
        let b = parseFloat(a);
        if (isNaN(b)) throw Error("Invalid amount: must be a valid number");
        if (b <= 0) throw Error("Invalid amount: must be greater than 0");
        let g = a.indexOf(".");
        if (-1 !== g && a.length - g - 1 > 2)
          throw Error(
            "Invalid amount: pay only supports up to 2 decimal places"
          );
        if (!r) throw Error("Invalid address: address is required");
        if (!(0, eY.isAddress)(r))
          throw Error("Invalid address: must be a valid Ethereum address");
        let y =
            ((e = (0, r1.parseUnits)(a, rZ.USDC.decimals)),
            (n = (0, ec.encodeFunctionData)({
              abi: rJ,
              functionName: "transfer",
              args: [r, e],
            })),
            (l = rV[(t = i ? "baseSepolia" : "base")]),
            (m = rZ.USDC.addresses[t]),
            (h = {}),
            s &&
              s.requests.length > 0 &&
              (h.dataCallback = {
        ...
        return (
          ...
          {
            success: !0,
            id: v.transactionHash,
            amount: a,
            to: r,
            payerInfoResponses: v.payerInfoResponses,
          }
        );
      } catch (n) {
            ...
            : n &&
              ...
              ("string" == typeof (null == n ? void 0 : n.message)
                ...
                : "string" == typeof (null == n ? void 0 : n.reason) &&
                  (e = n.reason)),
          c &&
            (({ amount: e, testnet: t, correlationId: n, errorMessage: a }) => {
              el(
                "payment.pay.error",
                {
                  action: f.error,
            ...
            })({ amount: a, testnet: i, correlationId: u, errorMessage: e }),
          { success: !1, error: e, amount: a, to: r }
        );
      }
    }
    e.s(
      [
        ...
        0,
        {
          pay: r2,
          getPaymentStatus: r_,
          constants: { CHAIN_IDS: rV, TOKENS: rZ },
          types: {},
        },
