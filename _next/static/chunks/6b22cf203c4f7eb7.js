(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var s = e.i(928020),
      t = 0;
    function i(e, i, o, r, n, l) {
      i || (i = {});
      var d,
        a,
        c = i;
      "ref" in i && ((d = i.ref), delete i.ref);
      var p = {
        type: e,
        props: c,
        key: o,
      ...
      if ("function" == typeof e && (d = e.defaultProps))
        for (a in d) void 0 === c[a] && (c[a] = d[a]);
      return s.options.vnode && s.options.vnode(p), p;
    }
    e.s(["jsx", () => i, "jsxs", () => i]);
  },
]);
