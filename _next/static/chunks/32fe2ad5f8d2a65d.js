(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let p = BigInt(0x100000000 - 1),
      ...
      _ = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0),
      O = (e, t, r, n) => (t + r + n + ((e / 0x100000000) | 0)) | 0,
      S = (e, t, r, n) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0),
      A = (e, t, r, n, i) => (t + r + n + i + ((e / 0x100000000) | 0)) | 0,
      I = (e, t, r, n, i, o) =>
    ...
    class U extends d {
      ...
      get() {
        ...
        return [e, t, r, n, i, o, s, a, c, l, u, f, h, d, p, b];
      }
      set(e, t, r, n, i, o, s, a, c, l, u, f, h, d, p, b) {
        (this.Ah = 0 | e),
          (this.Al = 0 | t),
          (this.Bh = 0 | r),
          (this.Bl = 0 | n),
      ...
      process(e, t) {
        for (let r = 0; r < 16; r++, t += 4)
          (N[r] = e.getUint32(t)), (C[r] = e.getUint32((t += 4)));
        for (let e = 16; e < 80; e++) {
          let t = 0 | N[e - 15],
            r = 0 | C[e - 15],
            n = m(t, r, 1) ^ m(t, r, 8) ^ y(t, r, 7),
            i = w(t, r, 1) ^ w(t, r, 8) ^ g(t, r, 7),
            o = 0 | N[e - 2],
            s = 0 | C[e - 2],
            a = m(o, s, 19) ^ v(o, s, 61) ^ y(o, s, 6),
            c = S(
              i,
              w(o, s, 19) ^ E(o, s, 61) ^ g(o, s, 6),
              C[e - 7],
              C[e - 16]
            ),
            l = A(c, n, a, N[e - 7], N[e - 16]);
          (N[e] = 0 | l), (C[e] = 0 | c);
        }
        let {
          Ah: r,
        ...
        for (let e = 0; e < 80; e++) {
          let t = m(u, f, 14) ^ m(u, f, 18) ^ v(u, f, 41),
            y = w(u, f, 14) ^ w(u, f, 18) ^ E(u, f, 41),
            g = (u & h) ^ (~u & p),
            S = T(R, y, (f & d) ^ (~f & b), P[e], C[e]),
            A = I(S, U, t, g, B[e], N[e]),
            D = 0 | S,
            j = m(r, n, 28) ^ v(r, n, 34) ^ v(r, n, 39),
            M = w(r, n, 28) ^ E(r, n, 34) ^ E(r, n, 39),
            k = (r & i) ^ (r & s) ^ (i & s),
            L = (n & o) ^ (n & a) ^ (o & a);
          (U = 0 | p),
            (R = 0 | b),
        ...
        ({ h: r, l: n } = x(0 | this.Ah, 0 | this.Al, 0 | r, 0 | n)),
          ({ h: i, l: o } = x(0 | this.Bh, 0 | this.Bl, 0 | i, 0 | o)),
          ({ h: s, l: a } = x(0 | this.Ch, 0 | this.Cl, 0 | s, 0 | a)),
          ({ h: c, l: l } = x(0 | this.Dh, 0 | this.Dl, 0 | c, 0 | l)),
          ({ h: u, l: f } = x(0 | this.Eh, 0 | this.El, 0 | u, 0 | f)),
          ({ h: h, l: d } = x(0 | this.Fh, 0 | this.Fl, 0 | h, 0 | d)),
          ({ h: p, l: b } = x(0 | this.Gh, 0 | this.Gl, 0 | p, 0 | b)),
          ({ h: U, l: R } = x(0 | this.Hh, 0 | this.Hl, 0 | U, 0 | R)),
          this.set(r, n, i, o, s, a, c, l, u, f, h, d, p, b, U, R);
      }
      roundClean() {
        N.fill(0), C.fill(0);
      }
    ...
    let R =
        ((n = () => new U()),
        ((t = (e) => n().update(u(e)).digest()).outputLen = (r =
          n()).outputLen),
    ...
    function K(e) {
      return L(e), H(F(Uint8Array.from(e).reverse()));
    }
    function $(e, t) {
      ...
      eD = (function (e) {
        ...
        let w = et((e, t) => {
            let { ex: r, ey: n, ez: o } = e,
              s = e.is0();
            null == t && (t = s ? eA : i.inv(o));
            let a = h(r * t),
              c = h(n * t),
              l = h(o * t);
            if (s) return { x: e_, y: eO };
            if (l !== eO) throw Error("invZ was invalid");
            return { x: a, y: c };
          }),
          v = et((e) => {
            let { a: t, d: r } = n;
        ...
        class E {
          ...
          static fromAffine(e) {
            ...
            let { x: t, y: r } = e || {};
            return g("x", t), g("y", r), new E(t, r, eO, h(t * r));
          }
          static normalizeZ(e) {
          ...
          add(e) {
            ...
            let { a: t, d: r } = n,
              ...
              { ex: c, ey: l, ez: u, et: f } = e;
            if (t === BigInt(-1)) {
              let e = h((o - i) * (l + c)),
                t = h((o + i) * (l - c)),
                r = h(t - e);
              if (r === e_) return this.double();
              let n = h(s * eS * f),
                d = h(a * eS * u),
                p = d + n,
                b = t + e,
            ...
            let d = h(i * c),
              ...
              O = h(v * x),
              S = h(g * x);
            return new E(_, O, h(w * v), S);
          }
          subtract(e) {
            return this.add(e.negate());
          }
          wNAF(e) {
            return O.wNAFCached(this, e, E.normalizeZ);
          }
          multiply(e) {
            X("scalar", e, eO, o);
          ...
          multiplyUnsafe(e, t = E.ZERO) {
            return (
              ...
              e === e_
                ...
                : this.is0() || e === eO
                ? this
                : O.wNAFCachedUnsafe(this, e, E.normalizeZ, t)
            );
          }
          isSmallOrder() {
          ...
          clearCofactor() {
            let { h: e } = n;
            return e === eO ? this : this.multiplyUnsafe(e);
          }
          static fromHex(e, t = !1) {
            let { d: r, a: o } = n,
              s = i.BYTES;
            (e = Y("pointHex", e, s)), W("zip215", t);
            let a = e.slice(),
              c = e[s - 1];
            a[s - 1] = -129 & c;
            let l = K(a);
            X("pointHex.y", l, e_, t ? f : i.ORDER);
            let u = h(l * l),
              { isValid: d, value: b } = p(h(u - eO), h(r * u - o));
            if (!d) throw Error("Point.fromHex: invalid y coordinate");
            let y = (b & eO) === eO,
              g = (128 & c) != 0;
            if (!t && b === e_ && g)
              throw Error("Point.fromHex: x=0 and x_0=1");
            return g !== y && (b = h(-b)), E.fromAffine({ x: b, y: l });
          }
          ...
          toRawBytes() {
            let { x: e, y: t } = this.toAffine(),
              r = J(t, i.BYTES);
            return (r[r.length - 1] |= e & eO ? 128 : 0), r;
          }
          toHex() {
            return F(this.toRawBytes());
          }
        }
        (E.BASE = new E(n.Gx, n.Gy, eO, h(n.Gx * n.Gy))),
          (E.ZERO = new E(e_, eO, eO, e_));
        let { BASE: x, ZERO: _ } = E,
          O =
            ((t = 8 * l),
            {
              ...
              precomputeWindow(e, r) {
                let { windows: n, windowSize: i } = ew(r, t),
                  o = [],
                  s = e,
                  a = s;
                for (let e = 0; e < n; e++) {
              ...
              wNAF(e, r, n) {
                let { windows: i, windowSize: o } = ew(e, t),
                  s = E.ZERO,
                  a = E.BASE,
                  c = BigInt(2 ** e - 1),
                  l = 2 ** e,
              ...
              wNAFUnsafe(e, r, n, i = E.ZERO) {
                let { windows: o, windowSize: s } = ew(e, t),
                  a = BigInt(2 ** e - 1),
                  c = 2 ** e,
                  l = BigInt(e);
                for (let e = 0; e < o; e++) {
                  ...
                  if (n === eb) break;
                  let o = Number(n & a);
                  if (((n >>= l), o > s && ((o -= c), (n += ey)), 0 === o))
                    continue;
                  let u = r[t + Math.abs(o) - 1];
        ...
        function S(e) {
          ...
          let r = Y("hashed private key", a(e), 2 * t),
            ...
            l = x.multiply(c),
            u = l.toRawBytes();
          return { head: n, prefix: s, scalar: c, point: l, pointBytes: u };
        }
        ...
        return (
          x._setWindowSize(8),
          {
            ...
            sign: function (e, t, r = {}) {
              ...
              let { prefix: n, scalar: a, pointBytes: c } = S(t),
                l = A(r.context, n, e),
                u = x.multiply(l).toRawBytes(),
                f = el(l + A(r.context, u, c, e) * a, o);
              return (
                X("signature.s", f, e_, o),
                Y("result", G(u, J(f, i.BYTES)), 2 * i.BYTES)
              );
            },
            verify: function (e, t, r, n = eI) {
              let o,
                a,
                c,
                { context: l, zip215: u } = n,
                f = i.BYTES;
              (e = Y("signature", e, 2 * f)),
                (t = Y("message", t)),
                (r = Y("publicKey", r, f)),
              ...
              try {
                (o = E.fromHex(r, u)),
                  (a = E.fromHex(e.slice(0, f), u)),
                  (c = x.multiplyUnsafe(h));
              } catch {
                return !1;
              }
              if (!u && o.isSmallOrder()) return !1;
              let d = A(l, a.toRawBytes(), o.toRawBytes(), t);
              return a
        ...
        uvRatio: function (e, t) {
          ...
          let n,
            ...
            (b = (eu(p, s, eT) * d) % eT),
            (y = (eu(b, n, eT) * u) % eT),
            { pow_p_5_8: (eu(y, eN, eT) * r) % eT, b2: a }).pow_p_5_8,
            w = el(e * g * m, eT),
            v = el(t * w * w, eT),
            E = w,
            x = el(w * eB, eT),
    ...
    function ez(e = 0) {
      return null != globalThis.Buffer && null != globalThis.Buffer.allocUnsafe
        ? eW(globalThis.Buffer.allocUnsafe(e))
        : new Uint8Array(e);
    }
    function eF(e, t) {
      ...
      return {
        encode: function (t) {
          ...
          for (var r = 0, n = 0, i = 0, o = t.length; i !== o && 0 === t[i]; )
            i++, r++;
          for (
            var s = ((o - i) * u + 1) >>> 0, l = new Uint8Array(s);
            i !== o;
          ...
          for (var b = c.repeat(r); p < s; ++p) b += e.charAt(l[p]);
          return b;
        },
        decodeUnsafe: f,
        decode: function (e) {
    ...
    let e4 = Array.from(
      ...
      e7 = e4.reduce((e, t, r) => ((e[r] = t), e), []),
      te = e4.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []);
    ...
    let ta = ({ name: e, code: t, encode: r }) => new tc(e, t, r);
    class tc {
      constructor(e, t, r) {
    ...
    function tm(e, t = "utf8") {
      ...
      return ("utf8" === t || "utf-8" === t) &&
        null != globalThis.Buffer &&
        null != globalThis.Buffer.from
        ? eW(globalThis.Buffer.from(e, "utf-8"))
        : r.decoder.decode(`${r.prefix}${e}`);
    }
    function tw(e) {
      return (0, o.safeJsonParse)(tg(tm(e, ej), eM));
    }
    function tv(e) {
      return tg(tm((0, o.safeJsonStringify)(e), eM), ej);
    }
    function tE(e) {
      return ["did:key", "z" + tg(eF([tm("K36", eL), e]), eL)].join(":");
    }
    function tx(e) {
      let t = e.split(".");
      return {
    ...
    function t_(e = h(32)) {
      ...
      return { secretKey: eF([e, t]), publicKey: t };
    }
    async function tO(e, t, r, n, o = (0, i.fromMiliseconds)(Date.now())) {
      let s = { alg: "EdDSA", typ: "JWT" },
        a = { iss: tE(n.publicKey), sub: e, aud: t, iat: o, exp: o + r },
        c = tm(
          [tv((l = { header: s, payload: a }).header), tv(l.payload)].join("."),
          ek
        );
      var l,
        u = {
          header: s,
          payload: a,
          signature: eD.sign(c, n.secretKey.slice(0, 32)),
        };
      return [tv(u.header), tv(u.payload), tg(u.signature, ej)].join(".");
    }
    e.s([
      "decodeJWT",
      () => tx,
  ...
  (e) => {
    ...
    var w = e.i(909184);
    let v = g({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
    e.s(["base2", 0, v], 347043);
    var E = e.i(347043);
    let x = g({
      prefix: "7",
      name: "base8",
    ...
    e.s(["base8", 0, x], 209626);
    var _ = e.i(209626);
    let O = y({ prefix: "9", name: "base10", alphabet: "0123456789" });
    e.s(["base10", 0, O], 238593);
    var S = e.i(238593);
    let A = g({
        prefix: "f",
        name: "base16",
    ...
    e.s(["base16", 0, A, "base16upper", 0, I], 967748);
    var T = e.i(967748);
    let B = g({
        prefix: "b",
        name: "base32",
    ...
    e.s(["base36", 0, L, "base36upper", 0, W], 133198);
    var z = e.i(133198);
    let F = y({
        name: "base58btc",
        prefix: "z",
    ...
    e.s(["base58btc", 0, F, "base58flickr", 0, H], 201366);
    var V = e.i(201366);
    let q = g({
        prefix: "m",
        name: "base64",
    ...
    e.s(["decode", 0, en, "encodeTo", 0, ei, "encodingLength", 0, eo], 484226);
    let es = (e, t) => {
        let r = t.byteLength,
          n = eo(e),
          i = n + eo(r),
    ...
    e.s(
      ["Digest", () => el, "create", 0, es, "decode", 0, ea, "equals", 0, ec],
      241823
    );
    let eu = ({ name: e, code: t, encode: r }) => new ef(e, t, r);
    class ef {
      constructor(e, t, r) {
        (this.name = e), (this.code = t), (this.encode = r);
      }
    ...
    e.s(["Hasher", () => ef, "from", 0, eu], 529451);
    let eh = (e) => async (t) =>
        new Uint8Array(await crypto.subtle.digest(e, t)),
      ed = eu({ name: "sha2-256", code: 18, encode: eh("SHA-256") }),
      ep = eu({ name: "sha2-512", code: 19, encode: eh("SHA-512") });
    ...
    class eg {
      ...
      toV0() {
        if (0 === this.version) return this;
        {
          ...
          if (e !== eE) throw Error("Cannot convert a non dag-pb CID to CIDv0");
          if (t.code !== ex)
      ...
      equals(e) {
        return (
          ...
          ec(this.multihash, e.multihash)
        );
      }
      toString(e) {
        let { bytes: t, version: r, _baseCache: n } = this;
        return 0 === r ? ew(t, n, e || F.encoder) : ev(t, n, e || B.encoder);
      }
      toJSON() {
        return {
          code: this.code,
      ...
      static isCID(e) {
        return eI(/^0\.0/, eT), !!(e && (e[eO] || e.asCID === e));
      }
      ...
      static asCID(e) {
        ...
        if (null != e && e.asCID === e) {
          ...
          return new eg(t, r, n, i || e_(t, r, n.bytes));
        }
        if (null == e || !0 !== e[eO]) return null;
        {
      ...
      static create(e, t, r) {
        ...
        switch (e) {
          case 0:
            if (t === eE) return new eg(e, t, r, r.bytes);
            throw Error(
              `Version 0 CID must use dag-pb (code: ${eE}) block encoding`
            );
          case 1: {
            let n = e_(e, t, r.bytes);
    ...
    let em = (e, t) => {
        switch (e[0]) {
          case "Q": {
            let r = t || F;
            return [F.prefix, r.decode(`${F.prefix}${e}`)];
          }
          case F.prefix: {
            let r = t || F;
      ...
      eO = Symbol.for("@ipld/js-cid/CID"),
      eS = { writable: !1, configurable: !1, enumerable: !0 },
      eA = { writable: !1, enumerable: !1, configurable: !1 },
      eI = (e, t) => {
        if (e.test("0.0.0-dev")) console.warn(t);
        else throw Error(t);
      },
      eT = `CID.isCID(v) is deprecated and will be removed in the next major release.
...
`;
    e.i(484226), e.i(723472), e.i(529451), e.i(241823);
    let eB = { ...w, ...E, ..._, ...S, ...T, ...k, ...z, ...V, ...Y, ...ee };
    e.s(["bases", () => eB], 18531);
    let eP = {
      waku: {
  ...
  (e) => {
    ...
    function i(e) {
      ...
      if ("function" == typeof e.toJSON) return i(e.toJSON());
    ...
    function c(e = {}) {
      let f,
          ...
          mounts: {
            "":
              ...
              ((f = new Map()),
              {
                ...
                getInstance: () => f,
                hasItem: (e) => f.has(e),
                getItem: (e) => f.get(e) ?? null,
                getItemRaw: (e) => f.get(e) ?? null,
                setItem(e, t) {
                  f.set(e, t);
                },
                setItemRaw(e, t) {
        ...
        b = (e, t) => {
          if (h.watching) for (let r of ((t = s(t)), h.watchListeners)) r(e, t);
        },
        y = async () => {
          if (!h.watching)
            for (let e in ((h.watching = !0), h.mounts))
              h.unwatch[e] = await l(h.mounts[e], b, e);
        },
        g = async () => {
          if (h.watching) {
        ...
        w = {
          hasItem(e, t = {}) {
            let { relativeKey: r, driver: i } = d((e = s(e)));
            return n(i.hasItem, r, t);
          },
          getItem(e, r = {}) {
            let { relativeKey: i, driver: o } = d((e = s(e)));
            return n(o.getItem, i, r).then((e) => (0, t.default)(e));
          },
          getItems: (e, r = {}) =>
            m(e, r, (e) =>
              e.driver.getItems
                ? n(
                    ...
                    r.map((r) => ({
                      ...
                      value: (0, t.default)(r.value),
                    }))
                  )
                : Promise.all(
                    e.items.map((r) =>
                      n(e.driver.getItem, r.relativeKey, r.options).then(
                        (e) => ({ key: r.key, value: (0, t.default)(e) })
                      )
                    )
                  )
            ),
          getItemRaw(e, t = {}) {
            let { relativeKey: i, driver: a } = d((e = s(e)));
            return a.getItemRaw
              ? n(a.getItemRaw, i, t)
              : n(a.getItem, i, t).then((e) => {
                  var t;
                  return "string" == typeof e && e.startsWith(o)
                    ? ((t = e.slice(o.length)),
                      globalThis.Buffer
          ...
          async setItem(e, t, r = {}) {
            if (void 0 === t) return w.removeItem(e);
            let { relativeKey: o, driver: a } = d((e = s(e)));
            a.setItem &&
              (await n(a.setItem, o, i(t), r), a.watch || b("update", e));
          },
          async setItems(e, t) {
            await m(e, t, async (e) => {
              ...
              e.driver.setItem &&
                (await Promise.all(
                  e.items.map((t) =>
                    n(e.driver.setItem, t.relativeKey, i(t.value), t.options)
                  )
                ));
            });
          },
          async setItemRaw(e, t, i = {}) {
            if (void 0 === t) return w.removeItem(e, i);
            let { relativeKey: a, driver: c } = d((e = s(e)));
            if (c.setItemRaw) await n(c.setItemRaw, a, t, i);
            else {
              var l;
              if (!c.setItem) return;
              await n(
                ...
                "string" == typeof t
                  ...
                  : o +
                      ((l = t),
                      globalThis.Buffer
                        ? r.Buffer.from(l).toString("base64")
          ...
          async removeItem(e, t = {}) {
            ...
            let { relativeKey: r, driver: i } = d((e = s(e)));
            i.removeItem &&
              (await n(i.removeItem, r, t),
              (t.removeMeta || t.removeMata) &&
                (await n(i.removeItem, r + "$", t)),
              i.watch || b("remove", e));
          },
          async getMeta(e, r = {}) {
            "boolean" == typeof r && (r = { nativeOnly: r });
            let { relativeKey: i, driver: o } = d((e = s(e))),
              a = Object.create(null);
            if (
              (o.getMeta && Object.assign(a, await n(o.getMeta, i, r)),
              !r.nativeOnly)
            ) {
              let e = await n(o.getItem, i + "$", r).then((e) =>
                (0, t.default)(e)
              );
              e &&
                "object" == typeof e &&
          ...
          async getKeys(e, t = {}) {
            let r = p((e = a(e)), !0),
              ...
              c = !0;
            for (let e of r) {
              for (let r of (e.driver.flags?.maxDepth || (c = !1),
              await n(e.driver.getKeys, e.relativeBase, t))) {
                let t = e.mountpoint + s(r);
          ...
          async clear(e, t = {}) {
            (e = a(e)),
              await Promise.all(
                p(e, !1).map(async (e) =>
                  e.driver.clear
                    ? n(e.driver.clear, e.relativeBase, t)
                    : e.driver.removeItem
                    ? Promise.all(
                        (
          ...
          async dispose() {
            await Promise.all(Object.values(h.mounts).map((e) => u(e)));
          },
          watch: async (e) => (
            await y(),
          ...
          getMounts: (e = "", t = {}) =>
            p((e = s(e)), t.parents).map((e) => ({
              driver: e.driver,
              base: e.mountpoint,
            })),
          keys: (e, t = {}) => w.getKeys(e, t),
          get: (e, t = {}) => w.getItem(e, t),
          set: (e, t, r = {}) => w.setItem(e, t, r),
          has: (e, t = {}) => w.hasItem(e, t),
          del: (e, t = {}) => w.removeItem(e, t),
          remove: (e, t = {}) => w.removeItem(e, t),
        };
      return w;
    }
    function l(e, t, r) {
    ...
    async function u(e) {
      "function" == typeof e.dispose && (await n(e.dispose));
    }
    e.s(["createStorage", () => c], 18035);
  },
  499276,
  (e) => {
    "use strict";
    ...
    (c.prototype.getItem = function (e) {
      ...
      (c.prototype.setItem = function (e, t) {
        this[e] = String(t);
      }),
      (c.prototype.removeItem = function (e) {
        delete this[e];
      }),
  ...
  (e, t, r) => {
    ...
    t.exports = function (e, t, r) {
      ...
      if (0 === c) return e;
      for (
        var l = "", u = 0, f = -1, h = (e && e.length) || 0, d = 0;
        d < h;
  ...
  (e, t, r) => {
    ...
    (function (t) {
      var r = (void 0 !== i && i) || ("u" > typeof self && self) || e.g || {},
        n = {
        ...
        return new Promise(function (o, s) {
          ...
          if (
            ...
            Object.getOwnPropertyNames(i.headers).forEach(function (e) {
              d.push(a(e)), f.setRequestHeader(e, c(i.headers[e]));
            }),
      ...
      (E.polyfill = !0),
        r.fetch ||
          ((r.fetch = E), (r.Headers = u), (r.Request = g), (r.Response = w)),
        (t.Headers = u),
        (t.Request = g),
        (t.Response = w),
        (t.fetch = E),
  ...
  (e) => {
      ...
      return {
        ...
        error:
          ...
          void 0 === c
            ? s(r)
            : ("string" == typeof c &&
                (c = Object.assign(Object.assign({}, s(n)), { message: c })),
              void 0 !== l && (c.data = l),
              (u = c.code),
              i.includes(u) &&
                ((f = c.code),
                (c = (h = Object.values(o).find((e) => e.code === f)) || o[n])),
              c)),
      };
    }
    c.isNode,
    ...
    class S extends y {
      ...
      async request(e, t) {
        return this.requestStrict(
          f(e.method, e.params || [], e.id || u().toString()),
          t
        );
      }
    ...
    class B {
      ...
      emitError(e) {
        let t = this.parseError(
          Error(
            e?.message || `WebSocket connection failed for host: ${I(this.url)}`
          )
        );
        return this.events.emit("register_error", t), t;
      }
    }
    e.s(["default", () => B], 112324);
    var P = e.i(320502),
      ...
      k = (e, t) => {
        ...
        if (R) for (var r of R(t)) j.call(t, r) && M(e, r, t[r]);
        return e;
      };
    let L = {
      headers: {
    ...
    class W {
      ...
      async send(e) {
        ...
        try {
          let t,
            r,
            n = (0, A.safeJsonStringify)(e),
            i = await (
              await (0, P.default)(
                this.url,
                ((t = k({}, L)), (r = { body: n }), C(t, U(r)))
              )
            ).json();
    ...
    e.s(["HttpConnection", () => W, "default", () => W], 98418);
  },
]);
